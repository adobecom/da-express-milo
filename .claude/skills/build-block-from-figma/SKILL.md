...
Example (branch name is the Jira ticket key — see
`references/remote-branch-workflow.md` section 2 for the naming
convention and length limit):
```
https://mwpw-206411--da-express-milo--adobecom.aem.live/drafts/methomas/test-page
```
