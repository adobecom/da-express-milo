...
/**
 * Page: Adobe Express Frictionless QA - Convert Video to Gif page
...
const PAGE_URL = 'https://www.adobe.com/express/feature/video/convert/video-to-gif';

test.describe('Video to GIF Converter Check Monitoring', () => {
  test('[Test Id - video-to-gif] @video-to-gif-check @monitoring @express', async ({ page, browserName }) => {
