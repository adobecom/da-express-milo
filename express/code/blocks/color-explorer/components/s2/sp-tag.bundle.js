...
var _ = () => {
  const i4 = document.documentElement.dir === "rtl" ? document.documentElement.dir : "ltr";
  l.forEach((c6) => {
    c6.setAttribute("dir", i4);
  });
};
...
var b = (i4) => typeof i4.startManagingContentDirection < "u" || i4.tagName === "SP-THEME";
function v(i4) {
  class c6 extends i4 {
    /**
     * @private
    ...
    hasVisibleFocusInTree() {
      const n6 = ((a2 = document) => {
        let t4 = a2.activeElement;
        for (; t4?.shadowRoot && t4.shadowRoot.activeElement; )
          t4 = t4.shadowRoot.activeElement;
        const s4 = t4 ? [t4] : [];
        for (; t4; ) {
          const o7 = t4.assignedSlot || t4.parentElement || t4.getRootNode()?.host;
          o7 && s4.push(o7), t4 = o7;
        }
        return s4;
      })(
...
if (true) {
  ...
  window.__swc = {
    ...
    warn: (r4, e6, n6, { type: a2 = "api", level: t4 = "default", issues: s4 } = {}) => {
      const { localName: o7 = "base" } = r4 || {}, u7 = `${o7}:${a2}:${t4}`;
      if (!window.__swc.verbose && window.__swc.issuedWarnings.has(u7) || window.__swc.ignoreWarningLocalNames[o7] || window.__swc.ignoreWarningTypes[a2] || window.__swc.ignoreWarningLevels[t4])
        return;
      window.__swc.issuedWarnings.add(u7);
      let m4 = "";
      s4 && s4.length && (s4.unshift(""), m4 = s4.join(`
    - `) + `
`);
      const w = t4 === "deprecation" ? "DEPRECATION NOTICE: " : "", h3 = r4 ? `
Inspect this issue in the follow element:` : "", g2 = (r4 ? `
...
var _2 = (r4, e6, i4, n6) => {
  for (var s4 = u(e6, i4), o7 = r4.length - 1, t4; o7 >= 0; o7--)
    (t4 = r4[o7]) && (s4 = t4(e6, i4, s4) || s4);
  return s4 && h(e6, i4, s4), s4;
};
var m = {
  xxs: "xxs",
  xs: "xs",
...
function d(r4, {
  ...
  const _s = class _s extends r4 {
    ...
    set size(t4) {
      const l4 = i4 ? null : n6, c6 = t4 && t4.toLocaleLowerCase(), p4 = e6.includes(c6) ? c6 : l4;
    ...
    update(t4) {
      !this.hasAttribute("size") && !i4 && this.setAttribute("size", this.size), super.update(t4);
    }
  };
  _s.VALID_SIZES = e6;
  let s4 = _s;
...
var n = (s4, r4, p4, i4) => {
  for (var t4 = i4 > 1 ? void 0 : i4 ? f2(r4, p4) : r4, a2 = s4.length - 1, l4; a2 >= 0; a2--) (l4 = s4[a2]) && (t4 = (i4 ? l4(r4, p4, t4) : l4(t4)) || t4);
  return i4 && t4 && u2(r4, p4, t4), t4;
};
function LikeAnchor(s4) {
  class r4 extends s4 {
    renderAnchor({ id: i4, className: t4, ariaHidden: a2, labelledby: l4, tabindex: d6, anchorContent: g2 = src_exports.html`<slot></slot>` }) {
...
var FocusVisiblePolyfillMixin = (a2) => {
  ...
  }, o7 = Symbol("endPolyfillCoordination");
  class c6 extends (t4 = a2, s4 = o7, t4) {
    constructor() {
      super(...arguments);
      this[s4] = null;
    }
...
var n2 = (s4, a2, e6, t4) => {
  for (var i4 = t4 > 1 ? void 0 : t4 ? b2(a2, e6) : a2, o7 = s4.length - 1, r4; o7 >= 0; o7--) (r4 = s4[o7]) && (i4 = (t4 ? r4(a2, e6, i4) : r4(i4)) || i4);
  return t4 && i4 && d2(a2, e6, i4), i4;
};
function u3() {
...
var Focusable = class extends FocusVisiblePolyfillMixin(C) {
  ...
  set tabIndex(e6) {
    ...
    if (this.focusElement === this) {
      if (this.disabled) this._tabIndex = e6;
        ...
        this._tabIndex = e6;
        const i4 = "" + e6;
        this.manipulatingTabindex = true, this.setAttribute("tabindex", i4);
      }
      return;
    }
    if (e6 === -1 ? this.addEventListener("pointerdown", this.onPointerdownManagementOfTabIndex) : (this.manipulatingTabindex = true, this.removeEventListener("pointerdown", this.onPointerdownManagementOfTabIndex)), e6 === -1 || this.disabled) {
      ...
      e6 !== -1 ? (this._tabIndex = e6, this.manageFocusElementTabindex(e6)) : (t4 = this.focusElement) == null || t4.removeAttribute("tabindex");
      return;
    }
  ...
  async handleDisabledChanged(e6, t4) {
    const i4 = () => this.focusElement !== this && typeof this.focusElement.disabled != "undefined";
    e6 ? (this.manipulatingTabindex = true, this.setAttribute("tabindex", "-1"), await this.updateComplete, i4() ? this.focusElement.disabled = true : this.setAttribute("aria-disabled", "true")) : t4 && (this.manipulatingTabindex = true, this.focusElement === this ? this.setAttribute("tabindex", "" + this._tabIndex) : this.removeAttribute("tabindex"), await this.updateComplete, i4() ? this.focusElement.disabled = false : this.removeAttribute("aria-disabled"));
  }
...
var a = class {
  constructor(t4, { target: s4, config: e6, callback: i4, skipInitial: h3 }) {
    this.t = /* @__PURE__ */ new Set(), this.o = false, this.i = false, this.h = t4, s4 !== null && this.t.add(s4 ?? t4), this.l = e6, this.o = h3 ?? this.o, this.callback = i4, window.MutationObserver ? (this.u = new MutationObserver((o7) => {
      this.handleChanges(o7), this.h.requestUpdate();
    }), t4.addController(this)) : console.warn("MutationController error: browser does not support MutationObserver.");
  }
  handleChanges(t4) {
    this.value = this.callback?.(t4, this.u);
  }
  hostConnected() {
    for (const t4 of this.t) this.observe(t4);
  }
  hostDisconnected() {
    this.disconnect();
  }
  async hostUpdated() {
    const t4 = this.u.takeRecords();
    (t4.length || !this.o && this.i) && this.handleChanges(t4), this.i = false;
  }
  observe(t4) {
    this.t.add(t4), this.u.observe(t4, this.l), this.i = true, this.h.requestUpdate();
  }
  disconnect() {
    this.u.disconnect();
  }
...
var p = (d6, n6, i4, u7) => {
  for (var t4 = void 0, r4 = d6.length - 1, o7; r4 >= 0; r4--)
    (o7 = d6[r4]) && (t4 = o7(n6, i4, t4) || t4);
  return t4 && b3(n6, i4, t4), t4;
};
var f3 = Symbol("assignedNodes");
function N(d6, n6, i4 = []) {
  var u7, t4;
  const r4 = (c6) => (e6) => c6.matches(e6);
  class o7 extends (t4 = d6, u7 = f3, t4) {
    ...
    manageTextObservedSlot() {
      ...
      const e6 = [...this[f3]].filter(
        (l4) => {
          const s4 = l4;
          return s4.tagName ? !i4.some(r4(s4)) : s4.textContent ? s4.textContent.trim() : false;
        }
      );
    ...
    update(e6) {
      if (!this.hasUpdated) {
        const { childNodes: l4 } = this, s4 = [...l4].filter((h3) => {
          const a2 = h3;
          return a2.tagName ? i4.some(
            r4(a2)
          ) ? false : (
...
var s2 = (n6, i4, e6, t4) => {
  for (var r4 = t4 > 1 ? void 0 : t4 ? d3(i4, e6) : i4, a2 = n6.length - 1, l4; a2 >= 0; a2--) (l4 = n6[a2]) && (r4 = (t4 ? l4(i4, e6, r4) : l4(r4)) || r4);
  return t4 && r4 && u4(i4, e6, r4), r4;
};
var ButtonBase = class extends N(LikeAnchor(Focusable), "", ["sp-overlay,sp-tooltip"]) {
  ...
  shouldProxyClick(e6) {
    ...
    if (this.anchorElement) this.anchorElement.click(), t4 = true;
    else if (this.type !== "button") {
      const r4 = document.createElement("button");
      r4.type = this.type, this.insertAdjacentElement("afterend", r4), r4.click(), r4.remove(), t4 = true;
    }
    return t4;
  }
  renderAnchor() {
...
var SystemResolutionController = class {
  ...
  resolveSystem() {
    const e6 = new CustomEvent("sp-system-context", { bubbles: true, composed: true, detail: { callback: (t4, s4) => {
      const o7 = this.system;
      this.system = t4, this.unsubscribe = s4, this.host.requestUpdate(systemResolverUpdatedSymbol, o7);
    } }, cancelable: true });
...
var l3 = (i4, r4, e6, s4) => {
  for (var t4 = s4 > 1 ? void 0 : s4 ? m3(r4, e6) : r4, o7 = i4.length - 1, u7; o7 >= 0; o7--) (u7 = i4[o7]) && (t4 = (s4 ? u7(r4, e6, t4) : u7(t4)) || t4);
  return s4 && t4 && c3(r4, e6, t4), t4;
};
...
var Cross75Icon = ({ width: t4 = 24, height: e6 = 24, hidden: r4 = false, title: l4 = "Cross75" } = {}) => tag`<svg
...
var Cross75Icon2 = ({ width: t4 = 24, height: e6 = 24, hidden: r4 = false, title: l4 = "Cross75" } = {}) => tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${r4 ? "true" : "false"}
    role="img"
...
var Cross100Icon2 = ({ width: t4 = 24, height: e6 = 24, hidden: r4 = false, title: a2 = "Cross100" } = {}) => tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${r4 ? "true" : "false"}
    role="img"
...
o6("sp-icon-cross100", IconCross100);

// node_modules/@spectrum-web-components/tags/node_modules/@spectrum-web-components/icons-ui/src/icons-s2/Cross200.js
var Cross200Icon = ({ width: t4 = 24, height: e6 = 24, hidden: a2 = false, title: r4 = "Cross200" } = {}) => tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
...
var Cross200Icon2 = ({ width: t4 = 24, height: e6 = 24, hidden: a2 = false, title: r4 = "Cross200" } = {}) => tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${a2 ? "true" : "false"}
    role="img"
...
o6("sp-icon-cross200", IconCross200);

// node_modules/@spectrum-web-components/tags/node_modules/@spectrum-web-components/icons-ui/src/icons-s2/Cross300.js
var Cross300Icon = ({ width: t4 = 24, height: e6 = 24, hidden: a2 = false, title: r4 = "Cross300" } = {}) => tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${a2 ? "true" : "false"}
    role="img"
...
var Cross300Icon2 = ({ width: t4 = 24, height: e6 = 24, hidden: a2 = false, title: r4 = "Cross300" } = {}) => tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${a2 ? "true" : "false"}
    role="img"
...
o6("sp-icon-cross300", IconCross300);
...
var r = (c6, s4, t4, o7) => {
  for (var e6 = o7 > 1 ? void 0 : o7 ? u5(s4, t4) : s4, a2 = c6.length - 1, l4; a2 >= 0; a2--) (l4 = c6[a2]) && (e6 = (o7 ? l4(s4, t4, e6) : l4(e6)) || e6);
  return o7 && e6 && d4(s4, t4, e6), e6;
};
...
var ClearButton = class extends d(StyledButton, { noDefaultSize: true }) {
  ...
  set variant(t4) {
    const o7 = this._variant, e6 = this.staticColor;
    if (t4 !== "overBackground") {
      this.removeAttribute("variant"), this._variant = void 0, this.staticColor = void 0;
      return;
    }
    this.setAttribute("variant", t4), this._variant = t4, this.staticColor = "white", this.requestUpdate("variant", o7), this.requestUpdate("staticColor", e6);
  }
  get variant() {
...
o6("sp-clear-button", ClearButton);
...
var r3 = (l4, i4, e6, s4) => {
  for (var t4 = s4 > 1 ? void 0 : s4 ? p3(i4, e6) : i4, a2 = l4.length - 1, o7; a2 >= 0; a2--) (o7 = l4[a2]) && (t4 = (s4 ? o7(i4, e6, t4) : o7(t4)) || t4);
  return s4 && t4 && u6(i4, e6, t4), t4;
};
...
o6("sp-tag", Tag);
//# sourceMappingURL=sp-tag.bundle.js.map
