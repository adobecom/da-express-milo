...
const PLACEHOLDER_KEY_MAP = Object.freeze({
  ...
  modalTitle: 'color-contrast-checker-modal-title',
  modalEmptyMessage: 'color-contrast-checker-modal-empty-message',
  modalLevelPickerLabel: 'color-contrast-checker-modal-level-picker-label',
  modalBgSelectorLabel: 'color-contrast-checker-modal-bg-selector-label',
  modalIconsAndUi: 'color-contrast-checker-modal-icons-and-ui',
  modalRatioLabel: 'color-contrast-checker-modal-ratio-label',
  modalRowBackgroundLabel: 'color-contrast-checker-modal-row-background-label',
  modalMatrixAria: 'color-contrast-checker-modal-matrix-aria',
  modalForegroundAria: 'color-contrast-checker-modal-foreground-aria',
  modalBackgroundAria: 'color-contrast-checker-modal-background-aria',
  modalCardGridAria: 'color-contrast-checker-modal-card-grid-aria',
  modalBgChangeAnnounce: 'color-contrast-checker-modal-bg-change-announce',
  modalTabChangeAnnounce: 'color-contrast-checker-modal-tab-change-announce',
  modalLevelChangeAnnounce: 'color-contrast-checker-modal-level-change-announce',
  modalCellAriaSameColor: 'color-contrast-checker-modal-cell-aria-same-color',
  modalCellAriaPass: 'color-contrast-checker-modal-cell-aria-pass',
  modalCellAriaFail: 'color-contrast-checker-modal-cell-aria-fail',
  modalCellTooltipPass: 'color-contrast-checker-modal-cell-tooltip-pass',
  modalCellTooltipFail: 'color-contrast-checker-modal-cell-tooltip-fail',
  modalCardAriaPass: 'color-contrast-checker-modal-card-aria-pass',
  modalCardAriaFail: 'color-contrast-checker-modal-card-aria-fail',
});
