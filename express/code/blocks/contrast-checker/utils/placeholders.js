...
const PLACEHOLDER_KEY_MAP = Object.freeze({
  ...
  colorPaletteLabel: 'contrast-checker-color-palette-label',
  contrastCheckerLabel: 'contrast-checker-contrast-checker-label',
  colorBlindnessLabel: 'contrast-checker-color-blindness-label',
  undoLabel: 'contrast-checker-undo-label',
  redoLabel: 'contrast-checker-redo-label',
  ...
  contrastRatioTooltip: 'contrast-checker-contrast-ratio-tooltip',
  ...
  levelAaTooltip: 'contrast-checker-level-aa-tooltip',
  levelAaaTooltip: 'contrast-checker-level-aaa-tooltip',
