...
/**
 * Eager entry module — page bootstrap (scriptInit) and critical-path utils.
 * Deferred symbols load via dynamic import of utils.js inside loadPage().
 */
