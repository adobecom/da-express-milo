...
/** Display palette colors (from Figma/spec: teal, sky blue, brown, peach, orange-red). */
...
/** First palette from Figma 3088-201177; name "Palette name lorem ipsum". */
...
export function createColorDataService(config) {
  ...
  /** Mock palette list: first from Figma 3088-201177; rest use same colors for consistency. */
