...
export const DEFAULT_PLACEHOLDERS = Object.freeze({
  ...
  librariesNoContentHeading: 'You have 0 saved color themes or gradients.',
  librariesNoContentDescription: 'You can come here to download, edit, or share your saved color themes and gradients, and more.',
  librariesNoContentCta: 'Create a color palette now',
  ...
  librariesUndo: 'Undo',
  librariesRestoreSuccess: '{name} was restored to your library.',
  librariesRestoreError: 'Unable to undo. Please try again.',
  ...
  librariesModalTagHelp: 'Press return \u21B5 to create tag',
...
const PLACEHOLDER_KEY_MAP = Object.freeze({
  ...
  librariesNoContentHeading: 'color-libraries-no-content-heading',
  librariesNoContentDescription: 'color-libraries-no-content-description',
  librariesNoContentCta: 'color-libraries-no-content-cta',
  ...
  librariesUndo: 'color-libraries-undo',
  librariesRestoreSuccess: 'color-libraries-restore-success',
  librariesRestoreError: 'color-libraries-restore-error',
  ...
  librariesModalTagHelp: 'color-drawer-tag-field-help',
  ...
  librariesCodesDisabledTooltip: 'color-libraries-codes-disabled-tooltip',
});
