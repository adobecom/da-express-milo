...
async function loadPickerOverrideStyles() {
  ...
  link.rel = 'stylesheet';
  link.href = '/express/code/scripts/color-shared/spectrum-picker-override.css';
...
export async function createFiltersComponent(options = {}) {
  ...
  async function loadSpectrumComponents() {
    ...
    try {
      ...
      const litModule = await import('../../widgets/spectrum/dist/lit.js');
      ...
      await import('../../widgets/spectrum/dist/base.js');
      ...
      const themeModule = await import('../../widgets/spectrum/dist/theme.js');
      ...
      await import('../../widgets/spectrum/dist/reactive-controllers.js');
