...
| **Palette cards** | `.color-explorer-strips` only (block-specific). L/M/S: 518/410/342, heights 80/56/56. **Strip↔footer gap 10px** (`--palette-card-strip-footer-gap`); component-only — demo/grid must not override. Footer 32px; name Label-M; actions gap 6; action buttons 32×32, radius 8, focus ring 2px. |
