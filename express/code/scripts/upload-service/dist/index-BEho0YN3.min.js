...
class kd {
  ...
  async initializeLogging() {
    const { LogService: e } = await import("./Logging-CFBvn5eu.min.js");
  ...
  handleError(e, s, r) {
    ...
    const o = r || n.message;
    return (d = window == null ? void 0 : window.lana) == null || d.log(JSON.stringify({
      service: "UploadService",
      errorCode: n.code || "UNKNOWN",
      errorMessage: o,
      environment: this.config.environment,
      tokenType: (a = this.config.authConfig) == null ? void 0 : a.tokenType,
    ...
    })), this.config.environment === "prod" && (n = He.UPLOAD_FAILED), new class extends Error {
      constructor(h, l, p) {
        super(h), this.code = l, this.originalError = p, this.name = "UploadServiceError";
      }
    }(o, n.code, s);
  }
  /**
...
//# sourceMappingURL=index-BEho0YN3.min.js.map
