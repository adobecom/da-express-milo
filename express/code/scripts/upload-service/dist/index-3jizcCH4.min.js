...
class kd {
  ...
  async initializeLogging() {
    const { LogService: e } = await import("./Logging-BG9FwZMo.min.js");
  ...
  handleError(e, s, r, n) {
    ...
    const i = r || o.message;
    return (h = window == null ? void 0 : window.lana) == null || h.log(JSON.stringify({
      service: "UploadService",
      errorCode: o.code || "UNKNOWN",
      errorMessage: i,
      environment: this.config.environment,
      tokenType: (d = this.config.authConfig) == null ? void 0 : d.tokenType,
      ...
      constructor(l, p, _) {
        super(l), this.code = p, this.originalError = _, this.name = "UploadServiceError";
      }
    }(i, o.code, s);
  }
  /**
...
//# sourceMappingURL=index-3jizcCH4.min.js.map
