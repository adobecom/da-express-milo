...
build({
  ...
  bundle: true,
  banner: { js: BANNER },
  entryPoints: [path.join(SPECTRUM_DIR, 'src/lit.js')],
  outfile: path.join(SPECTRUM_DIR, 'dist/lit.js'),
});
...
build({
  ...
  bundle: true,
  banner: { js: BANNER },
  entryPoints: [path.join(SPECTRUM_DIR, 'src/base.js')],
  plugins: [rewriteImportsForBase()],
  outfile: path.join(SPECTRUM_DIR, 'dist/base.js'),
});
...
iconMods.forEach((mod) => {
  build({
    ...
    bundle: true,
    banner: { js: BANNER },
    entryPoints: [path.join(SPECTRUM_DIR, 'src', mod)],
    outfile: path.join(SPECTRUM_DIR, 'dist', mod),
  });
});
