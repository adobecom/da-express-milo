...
import{html as W}from"./base.js";import{html as G,SpectrumElement as J}from"./base.js";import{SystemResolutionController as K,systemResolverUpdatedSymbol as N}from"./reactive-controllers.js";import{property as $,state as Q}from"./base.js";import{css as P}from"./base.js";var U=P`
...
`,b=U;var q=Object.defineProperty,F=Object.getOwnPropertyDescriptor,x=(t,e,o,r)=>{for(var a=r>1?void 0:r?F(e,o):e,w=t.length-1,v;w>=0;w--)(v=t[w])&&(a=(r?v(e,o,a):v(a))||a);return r&&a&&q(e,o,a),a},s=class extends J{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new K(this)}static get styles(){return[b]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(N)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return G`
            <slot></slot>
        `}};x([Q()],s.prototype,"spectrumVersion",2),x([$({reflect:!0})],s.prototype,"label",2),x([$({reflect:!0})],s.prototype,"size",2);var C,i=function(t,...e){return C?C(t,...e):e.reduce((o,r,a)=>o+r+t[a+1],t[0])},l=t=>{C=t};var T=({width:t=24,height:e=24,hidden:o=!1,title:r="Alert"}={})=>i`<svg
  ...
  >
    ...
    />
  </svg>`;var L=({width:t=24,height:e=24,hidden:o=!1,title:r="Alert Triangle"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var m=class extends s{render(){return l(W),this.spectrumVersion===1?T({hidden:!this.label,title:this.label}):L({hidden:!this.label,title:this.label})}};import{defineElement as X}from"./base.js";X("sp-icon-alert",m);import{html as Y}from"./base.js";var I=({width:t=24,height:e=24,hidden:o=!1,title:r="Edit"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Z=({width:t=24,height:e=24,hidden:o=!1,title:r="Edit"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
