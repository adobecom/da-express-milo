...
import{html as mt}from"./base.js";import{html as it,SpectrumElement as ot}from"./base.js";import{SystemResolutionController as st,systemResolverUpdatedSymbol as lt}from"./reactive-controllers.js";import{property as Z,state as at}from"./base.js";import{css as _}from"./base.js";var tt=_`
...
`,I=tt;var et=Object.defineProperty,rt=Object.getOwnPropertyDescriptor,T=(t,e,i,r)=>{for(var a=r>1?void 0:r?rt(e,i):e,b=t.length-1,$;b>=0;b--)($=t[b])&&(a=(r?$(e,i,a):$(a))||a);return r&&a&&et(e,i,a),a},s=class extends ot{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new st(this)}static get styles(){return[I]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(lt)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return it`
            <slot></slot>
        `}};T([at()],s.prototype,"spectrumVersion",2),T([Z({reflect:!0})],s.prototype,"label",2),T([Z({reflect:!0})],s.prototype,"size",2);var L,o=function(t,...e){return L?L(t,...e):e.reduce((i,r,a)=>i+r+t[a+1],t[0])},l=t=>{L=t};var B=({width:t=24,height:e=24,hidden:i=!1,title:r="Alert"}={})=>o`<svg
  ...
  >
    ...
    />
  </svg>`;var z=({width:t=24,height:e=24,hidden:i=!1,title:r="Alert Triangle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var m=class extends s{render(){return l(mt),this.spectrumVersion===1?B({hidden:!this.label,title:this.label}):z({hidden:!this.label,title:this.label})}};import{defineElement as ht}from"./base.js";ht("sp-icon-alert",m);import{html as ct}from"./base.js";var V=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var k=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var h=class extends s{render(){return l(ct),this.spectrumVersion===2?V({hidden:!this.label,title:this.label}):k({hidden:!this.label,title:this.label})}};import{defineElement as nt}from"./base.js";nt("sp-icon-edit",h);import{html as pt}from"./base.js";var M=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var y=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var c=class extends s{render(){return l(pt),this.spectrumVersion===2?M({hidden:!this.label,title:this.label}):y({hidden:!this.label,title:this.label})}};import{defineElement as dt}from"./base.js";dt("sp-icon-share-android",c);import{html as gt}from"./base.js";var A=({width:t=24,height:e=24,hidden:i=!1,title:r="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var S=({width:t=24,height:e=24,hidden:i=!1,title:r="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var n=class extends s{render(){return l(gt),this.spectrumVersion===2?A({hidden:!this.label,title:this.label}):S({hidden:!this.label,title:this.label})}};import{defineElement as ft}from"./base.js";ft("sp-icon-download",n);import{html as ut}from"./base.js";var E=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var H=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var p=class extends s{render(){return l(ut),this.spectrumVersion===2?E({hidden:!this.label,title:this.label}):H({hidden:!this.label,title:this.label})}};import{defineElement as wt}from"./base.js";wt("sp-icon-cclibrary",p);import{html as vt}from"./base.js";var D=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var R=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var d=class extends s{render(){return l(vt),this.spectrumVersion===2?D({hidden:!this.label,title:this.label}):R({hidden:!this.label,title:this.label})}};import{defineElement as Ct}from"./base.js";Ct("sp-icon-chevron-down",d);import{html as xt}from"./base.js";var j=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var O=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(xt),this.spectrumVersion===2?j({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}};import{defineElement as bt}from"./base.js";bt("sp-icon-chevron-left",g);import{html as $t}from"./base.js";var P=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var U=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l($t),this.spectrumVersion===2?P({hidden:!this.label,title:this.label}):U({hidden:!this.label,title:this.label})}};import{defineElement as Tt}from"./base.js";Tt("sp-icon-chevron-right",f);import{html as Lt}from"./base.js";var q=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var F=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(Lt),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):F({hidden:!this.label,title:this.label})}};import{defineElement as It}from"./base.js";It("sp-icon-checkmark-circle",u);import{html as Zt}from"./base.js";var G=({width:t=24,height:e=24,hidden:i=!1,title:r="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var J=({width:t=24,height:e=24,hidden:i=!1,title:r="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var w=class extends s{render(){return l(Zt),this.spectrumVersion===2?G({hidden:!this.label,title:this.label}):J({hidden:!this.label,title:this.label})}};import{defineElement as Bt}from"./base.js";Bt("sp-icon-close-circle",w);import{html as zt}from"./base.js";var K=({width:t=24,height:e=24,hidden:i=!1,title:r="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var N=({width:t=24,height:e=24,hidden:i=!1,title:r="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(zt),this.spectrumVersion===2?K({hidden:!this.label,title:this.label}):N({hidden:!this.label,title:this.label})}};import{defineElement as Vt}from"./base.js";Vt("sp-icon-switch",v);import{html as kt}from"./base.js";var Q=({width:t=24,height:e=24,hidden:i=!1,title:r="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var W=({width:t=24,height:e=24,hidden:i=!1,title:r="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(kt),this.spectrumVersion===2?Q({hidden:!this.label,title:this.label}):W({hidden:!this.label,title:this.label})}};import{defineElement as Mt}from"./base.js";Mt("sp-icon-add",C);import{html as yt}from"./base.js";var X=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Y=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(yt),this.spectrumVersion===2?X({hidden:!this.label,title:this.label}):Y({hidden:!this.label,title:this.label})}};import{defineElement as At}from"./base.js";At("sp-icon-close",x);
