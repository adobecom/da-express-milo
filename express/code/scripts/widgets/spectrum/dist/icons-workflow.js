...
import{html as vt}from"./base.js";import{html as dt,SpectrumElement as gt}from"./base.js";import{SystemResolutionController as ft,systemResolverUpdatedSymbol as ut}from"./reactive-controllers.js";import{property as z,state as wt}from"./base.js";import{css as ht}from"./base.js";var ct=ht`
...
`,k=ct;var nt=Object.defineProperty,pt=Object.getOwnPropertyDescriptor,V=(t,e,i,r)=>{for(var a=r>1?void 0:r?pt(e,i):e,Z=t.length-1,B;Z>=0;Z--)(B=t[Z])&&(a=(r?B(e,i,a):B(a))||a);return r&&a&&nt(e,i,a),a},s=class extends gt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new ft(this)}static get styles(){return[k]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(ut)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return dt`
            <slot></slot>
        `}};V([wt()],s.prototype,"spectrumVersion",2),V([z({reflect:!0})],s.prototype,"label",2),V([z({reflect:!0})],s.prototype,"size",2);var M,o=function(t,...e){return M?M(t,...e):e.reduce((i,r,a)=>i+r+t[a+1],t[0])},l=t=>{M=t};var m=({width:t=24,height:e=24,hidden:i=!1,title:r="Alert"}={})=>o`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var c=class extends s{render(){return l(vt),this.spectrumVersion===1?m({hidden:!this.label,title:this.label}):h({hidden:!this.label,title:this.label})}};import{defineElement as xt}from"./base.js";xt("sp-icon-alert",c);import{html as Ct}from"./base.js";var n=class extends s{render(){return l(Ct),this.spectrumVersion===2?h({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as bt}from"./base.js";bt("sp-icon-alert-triangle",n);import{html as $t}from"./base.js";var A=({width:t=24,height:e=24,hidden:i=!1,title:r="Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var H=({width:t=24,height:e=24,hidden:i=!1,title:r="Circle Filled"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var p=class extends s{render(){return l($t),this.spectrumVersion===2?A({hidden:!this.label,title:this.label}):H({hidden:!this.label,title:this.label})}};import{defineElement as Tt}from"./base.js";Tt("sp-icon-circle",p);import{html as It}from"./base.js";var E=({width:t=24,height:e=24,hidden:i=!1,title:r="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var S=({width:t=24,height:e=24,hidden:i=!1,title:r="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var d=class extends s{render(){return l(It),this.spectrumVersion===2?E({hidden:!this.label,title:this.label}):S({hidden:!this.label,title:this.label})}};import{defineElement as Lt}from"./base.js";Lt("sp-icon-copy",d);import{html as yt}from"./base.js";var D=({width:t=24,height:e=24,hidden:i=!1,title:r="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var O=({width:t=24,height:e=24,hidden:i=!1,title:r="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(yt),this.spectrumVersion===2?D({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}};import{defineElement as Zt}from"./base.js";Zt("sp-icon-delete",g);import{html as Bt}from"./base.js";var j=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var R=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(Bt),this.spectrumVersion===2?j({hidden:!this.label,title:this.label}):R({hidden:!this.label,title:this.label})}};import{defineElement as Vt}from"./base.js";Vt("sp-icon-edit",f);import{html as Mt}from"./base.js";var F=({width:t=24,height:e=24,hidden:i=!1,title:r="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var P=({width:t=24,height:e=24,hidden:i=!1,title:r="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(Mt),this.spectrumVersion===2?F({hidden:!this.label,title:this.label}):P({hidden:!this.label,title:this.label})}};import{defineElement as kt}from"./base.js";kt("sp-icon-heart",u);import{html as zt}from"./base.js";var U=({width:t=24,height:e=24,hidden:i=!1,title:r="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var q=({width:t=24,height:e=24,hidden:i=!1,title:r="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var w=class extends s{render(){return l(zt),this.spectrumVersion===2?U({hidden:!this.label,title:this.label}):q({hidden:!this.label,title:this.label})}};import{defineElement as At}from"./base.js";At("sp-icon-open-in",w);import{html as Ht}from"./base.js";var G=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var J=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(Ht),this.spectrumVersion===2?G({hidden:!this.label,title:this.label}):J({hidden:!this.label,title:this.label})}};import{defineElement as Et}from"./base.js";Et("sp-icon-share-android",v);import{html as St}from"./base.js";var K=({width:t=24,height:e=24,hidden:i=!1,title:r="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var N=({width:t=24,height:e=24,hidden:i=!1,title:r="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var x=class extends s{render(){return l(St),this.spectrumVersion===2?K({hidden:!this.label,title:this.label}):N({hidden:!this.label,title:this.label})}};import{defineElement as Dt}from"./base.js";Dt("sp-icon-target",x);import{html as Ot}from"./base.js";var Q=({width:t=24,height:e=24,hidden:i=!1,title:r="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var W=({width:t=24,height:e=24,hidden:i=!1,title:r="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(Ot),this.spectrumVersion===2?Q({hidden:!this.label,title:this.label}):W({hidden:!this.label,title:this.label})}};import{defineElement as jt}from"./base.js";jt("sp-icon-download",C);import{html as Rt}from"./base.js";var X=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Y=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(Rt),this.spectrumVersion===2?X({hidden:!this.label,title:this.label}):Y({hidden:!this.label,title:this.label})}};import{defineElement as Ft}from"./base.js";Ft("sp-icon-cclibrary",b);import{html as Pt}from"./base.js";var _=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var tt=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=class extends s{render(){return l(Pt),this.spectrumVersion===2?_({hidden:!this.label,title:this.label}):tt({hidden:!this.label,title:this.label})}};import{defineElement as Ut}from"./base.js";Ut("sp-icon-chevron-down",$);import{html as qt}from"./base.js";var et=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var rt=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(qt),this.spectrumVersion===2?et({hidden:!this.label,title:this.label}):rt({hidden:!this.label,title:this.label})}};import{defineElement as Gt}from"./base.js";Gt("sp-icon-chevron-left",T);import{html as Jt}from"./base.js";var it=({width:t=24,height:e=24,hidden:i=!1,title:r="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ot=({width:t=24,height:e=24,hidden:i=!1,title:r="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var I=class extends s{render(){return l(Jt),this.spectrumVersion===2?it({hidden:!this.label,title:this.label}):ot({hidden:!this.label,title:this.label})}};import{defineElement as Kt}from"./base.js";Kt("sp-icon-add",I);import{html as Nt}from"./base.js";var st=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var lt=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var L=class extends s{render(){return l(Nt),this.spectrumVersion===2?st({hidden:!this.label,title:this.label}):lt({hidden:!this.label,title:this.label})}};import{defineElement as Qt}from"./base.js";Qt("sp-icon-close",L);import{html as Wt}from"./base.js";var at=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var mt=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var y=class extends s{render(){return l(Wt),this.spectrumVersion===2?at({hidden:!this.label,title:this.label}):mt({hidden:!this.label,title:this.label})}};import{defineElement as Xt}from"./base.js";Xt("sp-icon-checkmark-circle",y);
