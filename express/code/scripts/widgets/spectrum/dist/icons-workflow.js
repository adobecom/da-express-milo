...
import{html as xt}from"./base.js";import{html as pt,SpectrumElement as gt}from"./base.js";import{SystemResolutionController as ft,systemResolverUpdatedSymbol as ut}from"./reactive-controllers.js";import{property as M,state as wt}from"./base.js";import{css as ht}from"./base.js";var ct=ht`
...
`,z=ct;var nt=Object.defineProperty,dt=Object.getOwnPropertyDescriptor,V=(t,e,r,i)=>{for(var a=i>1?void 0:i?dt(e,r):e,Z=t.length-1,B;Z>=0;Z--)(B=t[Z])&&(a=(i?B(e,r,a):B(a))||a);return i&&a&&nt(e,r,a),a},s=class extends gt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new ft(this)}static get styles(){return[z]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(ut)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return pt`
            <slot></slot>
        `}};V([wt()],s.prototype,"spectrumVersion",2),V([M({reflect:!0})],s.prototype,"label",2),V([M({reflect:!0})],s.prototype,"size",2);var k,o=function(t,...e){return k?k(t,...e):e.reduce((r,i,a)=>r+i+t[a+1],t[0])},l=t=>{k=t};var m=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert"}={})=>o`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var c=class extends s{render(){return l(xt),this.spectrumVersion===1?m({hidden:!this.label,title:this.label}):h({hidden:!this.label,title:this.label})}};import{defineElement as vt}from"./base.js";vt("sp-icon-alert",c);import{html as Ct}from"./base.js";var n=class extends s{render(){return l(Ct),this.spectrumVersion===2?h({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as bt}from"./base.js";bt("sp-icon-alert-triangle",n);import{html as $t}from"./base.js";var A=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var d=class extends s{render(){return l($t),this.spectrumVersion===2?A({hidden:!this.label,title:this.label}):H({hidden:!this.label,title:this.label})}};import{defineElement as Tt}from"./base.js";Tt("sp-icon-circle",d);import{html as It}from"./base.js";var E=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var p=class extends s{render(){return l(It),this.spectrumVersion===2?E({hidden:!this.label,title:this.label}):D({hidden:!this.label,title:this.label})}};import{defineElement as yt}from"./base.js";yt("sp-icon-copy",p);import{html as Lt}from"./base.js";var S=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(kt),this.spectrumVersion===2?O({hidden:!this.label,title:this.label}):P({hidden:!this.label,title:this.label})}};import{defineElement as zt}from"./base.js";zt("sp-icon-edit",u);import{html as Mt}from"./base.js";var U=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var q=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var w=class extends s{render(){return l(Mt),this.spectrumVersion===2?U({hidden:!this.label,title:this.label}):q({hidden:!this.label,title:this.label})}};import{defineElement as At}from"./base.js";At("sp-icon-share-android",w);import{html as Ht}from"./base.js";var G=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var J=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var x=class extends s{render(){return l(Ht),this.spectrumVersion===2?G({hidden:!this.label,title:this.label}):J({hidden:!this.label,title:this.label})}};import{defineElement as Et}from"./base.js";Et("sp-icon-target",x);import{html as Dt}from"./base.js";var K=({width:t=24,height:e=24,hidden:r=!1,title:i="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var N=({width:t=24,height:e=24,hidden:r=!1,title:i="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(Dt),this.spectrumVersion===2?K({hidden:!this.label,title:this.label}):N({hidden:!this.label,title:this.label})}};import{defineElement as St}from"./base.js";St("sp-icon-download",v);import{html as jt}from"./base.js";var Q=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var W=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(jt),this.spectrumVersion===2?Q({hidden:!this.label,title:this.label}):W({hidden:!this.label,title:this.label})}};import{defineElement as Rt}from"./base.js";Rt("sp-icon-cclibrary",C);import{html as Ft}from"./base.js";var X=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Y=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(Ft),this.spectrumVersion===2?X({hidden:!this.label,title:this.label}):Y({hidden:!this.label,title:this.label})}};import{defineElement as Ot}from"./base.js";Ot("sp-icon-chevron-down",b);import{html as Pt}from"./base.js";var _=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=class extends s{render(){return l(Pt),this.spectrumVersion===2?_({hidden:!this.label,title:this.label}):tt({hidden:!this.label,title:this.label})}};import{defineElement as Ut}from"./base.js";Ut("sp-icon-chevron-left",$);import{html as qt}from"./base.js";var et=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var rt=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(qt),this.spectrumVersion===2?et({hidden:!this.label,title:this.label}):rt({hidden:!this.label,title:this.label})}};import{defineElement as Gt}from"./base.js";Gt("sp-icon-add",T);import{html as Jt}from"./base.js";var it=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var I=class extends s{render(){return l(Jt),this.spectrumVersion===2?it({hidden:!this.label,title:this.label}):ot({hidden:!this.label,title:this.label})}};import{defineElement as Kt}from"./base.js";Kt("sp-icon-close",I);import{html as Nt}from"./base.js";var st=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var lt=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var y=class extends s{render(){return l(Nt),this.spectrumVersion===2?st({hidden:!this.label,title:this.label}):lt({hidden:!this.label,title:this.label})}};import{defineElement as Qt}from"./base.js";Qt("sp-icon-checkmark-circle",y);import{html as Wt}from"./base.js";var at=({width:t=24,height:e=24,hidden:r=!1,title:i="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var L=class extends s{render(){return l(Wt),this.spectrumVersion===2?at({hidden:!this.label,title:this.label}):mt({hidden:!this.label,title:this.label})}};import{defineElement as Xt}from"./base.js";Xt("sp-icon-image",L);
