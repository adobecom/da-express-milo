...
import{html as Kt}from"./base.js";import{html as Nt,SpectrumElement as Ut}from"./base.js";import{SystemResolutionController as qt,systemResolverUpdatedSymbol as Gt}from"./reactive-controllers.js";import{property as U,state as Jt}from"./base.js";import{css as Ft}from"./base.js";var Rt=Ft`
...
`,N=Rt;var jt=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,j=(t,e,r,i)=>{for(var a=i>1?void 0:i?Pt(e,r):e,F=t.length-1,R;F>=0;F--)(R=t[F])&&(a=(i?R(e,r,a):R(a))||a);return i&&a&&jt(e,r,a),a},s=class extends Ut{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new qt(this)}static get styles(){return[N]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(Gt)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return Nt`
            <slot></slot>
        `}};j([Jt()],s.prototype,"spectrumVersion",2),j([U({reflect:!0})],s.prototype,"label",2),j([U({reflect:!0})],s.prototype,"size",2);var P,o=function(t,...e){return P?P(t,...e):e.reduce((r,i,a)=>r+i+t[a+1],t[0])},l=t=>{P=t};var h=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert"}={})=>o`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var n=class extends s{render(){return l(Kt),this.spectrumVersion===1?h({hidden:!this.label,title:this.label}):c({hidden:!this.label,title:this.label})}};import{defineElement as Qt}from"./base.js";Qt("sp-icon-alert",n);import{html as Wt}from"./base.js";var p=class extends s{render(){return l(Wt),this.spectrumVersion===2?c({hidden:!this.label,title:this.label}):h({hidden:!this.label,title:this.label})}};import{defineElement as Xt}from"./base.js";Xt("sp-icon-alert-triangle",p);import{html as Yt}from"./base.js";var q=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var d=class extends s{render(){return l(Yt),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):G({hidden:!this.label,title:this.label})}};import{defineElement as _t}from"./base.js";_t("sp-icon-circle",d);import{html as t1}from"./base.js";var J=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var g=class extends s{render(){return l(t1),this.spectrumVersion===2?J({hidden:!this.label,title:this.label}):K({hidden:!this.label,title:this.label})}};import{defineElement as e1}from"./base.js";e1("sp-icon-copy",g);import{html as r1}from"./base.js";var Q=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(r1),this.spectrumVersion===2?Q({hidden:!this.label,title:this.label}):W({hidden:!this.label,title:this.label})}};import{defineElement as i1}from"./base.js";i1("sp-icon-delete",f);import{html as o1}from"./base.js";var X=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(o1),this.spectrumVersion===2?X({hidden:!this.label,title:this.label}):Y({hidden:!this.label,title:this.label})}};import{defineElement as s1}from"./base.js";s1("sp-icon-edit",u);import{html as l1}from"./base.js";var _=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var w=class extends s{render(){return l(l1),this.spectrumVersion===2?_({hidden:!this.label,title:this.label}):tt({hidden:!this.label,title:this.label})}};import{defineElement as a1}from"./base.js";a1("sp-icon-heart",w);import{html as m1}from"./base.js";var et=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart Filled"}={})=>o`<svg
    data-name="ICONS"
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
  ...
  >
    ...
    `;var v=class extends s{render(){return l(m1),this.spectrumVersion===2?et({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as h1}from"./base.js";h1("sp-icon-heart-filled",v);import{html as c1}from"./base.js";var rt=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(c1),this.spectrumVersion===2?rt({hidden:!this.label,title:this.label}):it({hidden:!this.label,title:this.label})}};import{defineElement as n1}from"./base.js";n1("sp-icon-open-in",x);import{html as p1}from"./base.js";var ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var $=class extends s{render(){return l(g1),this.spectrumVersion===2?lt({hidden:!this.label,title:this.label}):at({hidden:!this.label,title:this.label})}};import{defineElement as f1}from"./base.js";f1("sp-icon-target",$);import{html as u1}from"./base.js";var mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(u1),this.spectrumVersion===2?mt({hidden:!this.label,title:this.label}):ht({hidden:!this.label,title:this.label})}};import{defineElement as w1}from"./base.js";w1("sp-icon-download",b);import{html as v1}from"./base.js";var ct=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(v1),this.spectrumVersion===2?ct({hidden:!this.label,title:this.label}):nt({hidden:!this.label,title:this.label})}};import{defineElement as x1}from"./base.js";x1("sp-icon-cclibrary",T);import{html as C1}from"./base.js";var pt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var L=class extends s{render(){return l(b1),this.spectrumVersion===2?gt({hidden:!this.label,title:this.label}):ft({hidden:!this.label,title:this.label})}};import{defineElement as T1}from"./base.js";T1("sp-icon-chevron-left",L);import{html as I1}from"./base.js";var ut=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var Z=class extends s{render(){return l(I1),this.spectrumVersion===2?ut({hidden:!this.label,title:this.label}):wt({hidden:!this.label,title:this.label})}};import{defineElement as L1}from"./base.js";L1("sp-icon-chevron-right",Z);import{html as Z1}from"./base.js";var vt=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var B=class extends s{render(){return l(B1),this.spectrumVersion===2?Ct({hidden:!this.label,title:this.label}):$t({hidden:!this.label,title:this.label})}};import{defineElement as V1}from"./base.js";V1("sp-icon-close-circle",B);import{html as k1}from"./base.js";var bt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var V=class extends s{render(){return l(k1),this.spectrumVersion===2?bt({hidden:!this.label,title:this.label}):Tt({hidden:!this.label,title:this.label})}};import{defineElement as M1}from"./base.js";M1("sp-icon-switch",V);import{html as H1}from"./base.js";var It=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var k=class extends s{render(){return l(H1),this.spectrumVersion===2?It({hidden:!this.label,title:this.label}):Lt({hidden:!this.label,title:this.label})}};import{defineElement as A1}from"./base.js";A1("sp-icon-add",k);import{html as E1}from"./base.js";var Zt=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var M=class extends s{render(){return l(E1),this.spectrumVersion===2?Zt({hidden:!this.label,title:this.label}):yt({hidden:!this.label,title:this.label})}};import{defineElement as z1}from"./base.js";z1("sp-icon-filter",M);import{html as S1}from"./base.js";var Bt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch Vertical"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var H=class extends s{render(){return l(S1),this.spectrumVersion===2?Bt({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as D1}from"./base.js";D1("sp-icon-switch-vertical",H);import{html as O1}from"./base.js";var Vt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var kt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var A=class extends s{render(){return l(O1),this.spectrumVersion===2?Vt({hidden:!this.label,title:this.label}):kt({hidden:!this.label,title:this.label})}};import{defineElement as F1}from"./base.js";F1("sp-icon-close",A);import{html as R1}from"./base.js";var Mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Accessibility"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var z=class extends s{render(){return l(P1),this.spectrumVersion===1?Ht({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as N1}from"./base.js";N1("sp-icon-checkmark-circle-outline",z);import{html as U1}from"./base.js";var At=({width:t=24,height:e=24,hidden:r=!1,title:i="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Et=({width:t=24,height:e=24,hidden:r=!1,title:i="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var S=class extends s{render(){return l(U1),this.spectrumVersion===2?At({hidden:!this.label,title:this.label}):Et({hidden:!this.label,title:this.label})}};import{defineElement as q1}from"./base.js";q1("sp-icon-image",S);import{html as G1}from"./base.js";var zt=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var St=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Closed"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var D=class extends s{render(){return l(G1),this.spectrumVersion===2?zt({hidden:!this.label,title:this.label}):St({hidden:!this.label,title:this.label})}};import{defineElement as J1}from"./base.js";J1("sp-icon-lock",D);import{html as K1}from"./base.js";var Dt=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Open"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Open"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var O=class extends s{render(){return l(K1),this.spectrumVersion===2?Dt({hidden:!this.label,title:this.label}):Ot({hidden:!this.label,title:this.label})}};import{defineElement as Q1}from"./base.js";Q1("sp-icon-lock-open",O);
