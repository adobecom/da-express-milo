...
import{html as Gt}from"./base.js";import{html as jt,SpectrumElement as Pt}from"./base.js";import{SystemResolutionController as Nt,systemResolverUpdatedSymbol as Ut}from"./reactive-controllers.js";import{property as N,state as qt}from"./base.js";import{css as Dt}from"./base.js";var Ot=Dt`
...
`,P=Ot;var Ft=Object.defineProperty,Rt=Object.getOwnPropertyDescriptor,R=(t,e,r,i)=>{for(var a=i>1?void 0:i?Rt(e,r):e,O=t.length-1,F;O>=0;O--)(F=t[O])&&(a=(i?F(e,r,a):F(a))||a);return i&&a&&Ft(e,r,a),a},s=class extends Pt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new Nt(this)}static get styles(){return[P]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(Ut)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return jt`
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var n=class extends s{render(){return l(Gt),this.spectrumVersion===1?h({hidden:!this.label,title:this.label}):c({hidden:!this.label,title:this.label})}};import{defineElement as Jt}from"./base.js";Jt("sp-icon-alert",n);import{html as Kt}from"./base.js";var p=class extends s{render(){return l(Kt),this.spectrumVersion===2?c({hidden:!this.label,title:this.label}):h({hidden:!this.label,title:this.label})}};import{defineElement as Qt}from"./base.js";Qt("sp-icon-alert-triangle",p);import{html as Wt}from"./base.js";var U=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var q=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle Filled"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var d=class extends s{render(){return l(Wt),this.spectrumVersion===2?U({hidden:!this.label,title:this.label}):q({hidden:!this.label,title:this.label})}};import{defineElement as Xt}from"./base.js";Xt("sp-icon-circle",d);import{html as Yt}from"./base.js";var G=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var J=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var g=class extends s{render(){return l(Yt),this.spectrumVersion===2?G({hidden:!this.label,title:this.label}):J({hidden:!this.label,title:this.label})}};import{defineElement as _t}from"./base.js";_t("sp-icon-copy",g);import{html as t2}from"./base.js";var K=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Q=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(t2),this.spectrumVersion===2?K({hidden:!this.label,title:this.label}):Q({hidden:!this.label,title:this.label})}};import{defineElement as e2}from"./base.js";e2("sp-icon-delete",f);import{html as r2}from"./base.js";var W=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var X=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(r2),this.spectrumVersion===2?W({hidden:!this.label,title:this.label}):X({hidden:!this.label,title:this.label})}};import{defineElement as i2}from"./base.js";i2("sp-icon-edit",u);import{html as o2}from"./base.js";var Y=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var _=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var w=class extends s{render(){return l(o2),this.spectrumVersion===2?Y({hidden:!this.label,title:this.label}):_({hidden:!this.label,title:this.label})}};import{defineElement as s2}from"./base.js";s2("sp-icon-heart",w);import{html as l2}from"./base.js";var tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart Filled"}={})=>o`<svg
    data-name="ICONS"
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
  ...
  >
    ...
    `;var v=class extends s{render(){return l(l2),this.spectrumVersion===2?tt({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as a2}from"./base.js";a2("sp-icon-heart-filled",v);import{html as m2}from"./base.js";var et=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var rt=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(m2),this.spectrumVersion===2?et({hidden:!this.label,title:this.label}):rt({hidden:!this.label,title:this.label})}};import{defineElement as h2}from"./base.js";h2("sp-icon-open-in",x);import{html as c2}from"./base.js";var it=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(c2),this.spectrumVersion===2?it({hidden:!this.label,title:this.label}):ot({hidden:!this.label,title:this.label})}};import{defineElement as n2}from"./base.js";n2("sp-icon-share-android",C);import{html as p2}from"./base.js";var st=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var lt=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var $=class extends s{render(){return l(p2),this.spectrumVersion===2?st({hidden:!this.label,title:this.label}):lt({hidden:!this.label,title:this.label})}};import{defineElement as d2}from"./base.js";d2("sp-icon-target",$);import{html as g2}from"./base.js";var at=({width:t=24,height:e=24,hidden:r=!1,title:i="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(g2),this.spectrumVersion===2?at({hidden:!this.label,title:this.label}):mt({hidden:!this.label,title:this.label})}};import{defineElement as f2}from"./base.js";f2("sp-icon-download",b);import{html as u2}from"./base.js";var ht=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ct=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(u2),this.spectrumVersion===2?ht({hidden:!this.label,title:this.label}):ct({hidden:!this.label,title:this.label})}};import{defineElement as w2}from"./base.js";w2("sp-icon-cclibrary",T);import{html as v2}from"./base.js";var nt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var pt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var I=class extends s{render(){return l(v2),this.spectrumVersion===2?nt({hidden:!this.label,title:this.label}):pt({hidden:!this.label,title:this.label})}};import{defineElement as x2}from"./base.js";x2("sp-icon-chevron-down",I);import{html as C2}from"./base.js";var dt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var gt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var L=class extends s{render(){return l(C2),this.spectrumVersion===2?dt({hidden:!this.label,title:this.label}):gt({hidden:!this.label,title:this.label})}};import{defineElement as $2}from"./base.js";$2("sp-icon-chevron-left",L);import{html as b2}from"./base.js";var ft=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ut=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var Z=class extends s{render(){return l(b2),this.spectrumVersion===2?ft({hidden:!this.label,title:this.label}):ut({hidden:!this.label,title:this.label})}};import{defineElement as T2}from"./base.js";T2("sp-icon-chevron-right",Z);import{html as I2}from"./base.js";var wt=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var vt=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var y=class extends s{render(){return l(I2),this.spectrumVersion===2?wt({hidden:!this.label,title:this.label}):vt({hidden:!this.label,title:this.label})}};import{defineElement as L2}from"./base.js";L2("sp-icon-checkmark-circle",y);import{html as Z2}from"./base.js";var xt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Ct=({width:t=24,height:e=24,hidden:r=!1,title:i="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var B=class extends s{render(){return l(Z2),this.spectrumVersion===2?xt({hidden:!this.label,title:this.label}):Ct({hidden:!this.label,title:this.label})}};import{defineElement as y2}from"./base.js";y2("sp-icon-close-circle",B);import{html as B2}from"./base.js";var $t=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var bt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var V=class extends s{render(){return l(B2),this.spectrumVersion===2?$t({hidden:!this.label,title:this.label}):bt({hidden:!this.label,title:this.label})}};import{defineElement as V2}from"./base.js";V2("sp-icon-switch",V);import{html as M2}from"./base.js";var Tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var It=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var M=class extends s{render(){return l(M2),this.spectrumVersion===2?Tt({hidden:!this.label,title:this.label}):It({hidden:!this.label,title:this.label})}};import{defineElement as k2}from"./base.js";k2("sp-icon-add",M);import{html as H2}from"./base.js";var Lt=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Zt=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var k=class extends s{render(){return l(H2),this.spectrumVersion===2?Lt({hidden:!this.label,title:this.label}):Zt({hidden:!this.label,title:this.label})}};import{defineElement as A2}from"./base.js";A2("sp-icon-filter",k);import{html as E2}from"./base.js";var yt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch Vertical"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var H=class extends s{render(){return l(E2),this.spectrumVersion===2?yt({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as z2}from"./base.js";z2("sp-icon-switch-vertical",H);import{html as S2}from"./base.js";var Bt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Vt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var A=class extends s{render(){return l(S2),this.spectrumVersion===2?Bt({hidden:!this.label,title:this.label}):Vt({hidden:!this.label,title:this.label})}};import{defineElement as D2}from"./base.js";D2("sp-icon-close",A);import{html as O2}from"./base.js";var Mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Accessibility"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var E=class extends s{render(){return l(O2),this.spectrumVersion===2?Mt({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as F2}from"./base.js";F2("sp-icon-accessibility",E);import{html as R2}from"./base.js";var kt=({width:t=24,height:e=24,hidden:r=!1,title:i="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Ht=({width:t=24,height:e=24,hidden:r=!1,title:i="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var z=class extends s{render(){return l(R2),this.spectrumVersion===2?kt({hidden:!this.label,title:this.label}):Ht({hidden:!this.label,title:this.label})}};import{defineElement as j2}from"./base.js";j2("sp-icon-image",z);import{html as P2}from"./base.js";var At=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Et=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Closed"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var S=class extends s{render(){return l(P2),this.spectrumVersion===2?At({hidden:!this.label,title:this.label}):Et({hidden:!this.label,title:this.label})}};import{defineElement as N2}from"./base.js";N2("sp-icon-lock",S);import{html as U2}from"./base.js";var zt=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Open"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var St=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Open"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var D=class extends s{render(){return l(U2),this.spectrumVersion===2?zt({hidden:!this.label,title:this.label}):St({hidden:!this.label,title:this.label})}};import{defineElement as q2}from"./base.js";q2("sp-icon-lock-open",D);
