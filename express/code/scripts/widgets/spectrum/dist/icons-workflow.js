...
import{html as Qt}from"./base.js";import{html as Ut,SpectrumElement as qt}from"./base.js";import{SystemResolutionController as Gt,systemResolverUpdatedSymbol as Jt}from"./reactive-controllers.js";import{property as U,state as Kt}from"./base.js";import{css as Rt}from"./base.js";var jt=Rt`
...
`,N=jt;var Pt=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,j=(t,e,r,i)=>{for(var a=i>1?void 0:i?Nt(e,r):e,F=t.length-1,R;F>=0;F--)(R=t[F])&&(a=(i?R(e,r,a):R(a))||a);return i&&a&&Pt(e,r,a),a},s=class extends qt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new Gt(this)}static get styles(){return[N]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(Jt)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return Ut`
            <slot></slot>
        `}};j([Kt()],s.prototype,"spectrumVersion",2),j([U({reflect:!0})],s.prototype,"label",2),j([U({reflect:!0})],s.prototype,"size",2);var P,o=function(t,...e){return P?P(t,...e):e.reduce((r,i,a)=>r+i+t[a+1],t[0])},l=t=>{P=t};var h=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert"}={})=>o`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var n=class extends s{render(){return l(Qt),this.spectrumVersion===1?h({hidden:!this.label,title:this.label}):c({hidden:!this.label,title:this.label})}};import{defineElement as Wt}from"./base.js";Wt("sp-icon-alert",n);import{html as Xt}from"./base.js";var p=class extends s{render(){return l(Xt),this.spectrumVersion===2?c({hidden:!this.label,title:this.label}):h({hidden:!this.label,title:this.label})}};import{defineElement as Yt}from"./base.js";Yt("sp-icon-alert-triangle",p);import{html as _t}from"./base.js";var q=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var G=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle Filled"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var d=class extends s{render(){return l(_t),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):G({hidden:!this.label,title:this.label})}};import{defineElement as t0}from"./base.js";t0("sp-icon-circle",d);import{html as e0}from"./base.js";var J=({width:t=24,height:e=24,hidden:r=!1,title:i="Code"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var K=({width:t=24,height:e=24,hidden:r=!1,title:i="Code"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(e0),this.spectrumVersion===2?J({hidden:!this.label,title:this.label}):K({hidden:!this.label,title:this.label})}};import{defineElement as r0}from"./base.js";r0("sp-icon-code",g);import{html as i0}from"./base.js";var Q=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var W=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var f=class extends s{render(){return l(i0),this.spectrumVersion===2?Q({hidden:!this.label,title:this.label}):W({hidden:!this.label,title:this.label})}};import{defineElement as o0}from"./base.js";o0("sp-icon-copy",f);import{html as s0}from"./base.js";var X=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Y=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(s0),this.spectrumVersion===2?X({hidden:!this.label,title:this.label}):Y({hidden:!this.label,title:this.label})}};import{defineElement as l0}from"./base.js";l0("sp-icon-delete",u);import{html as a0}from"./base.js";var _=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var w=class extends s{render(){return l(a0),this.spectrumVersion===2?_({hidden:!this.label,title:this.label}):tt({hidden:!this.label,title:this.label})}};import{defineElement as m0}from"./base.js";m0("sp-icon-edit",w);import{html as h0}from"./base.js";var et=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var rt=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(h0),this.spectrumVersion===2?et({hidden:!this.label,title:this.label}):rt({hidden:!this.label,title:this.label})}};import{defineElement as c0}from"./base.js";c0("sp-icon-heart",v);import{html as n0}from"./base.js";var it=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart Filled"}={})=>o`<svg
    data-name="ICONS"
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
  ...
  >
    ...
    `;var x=class extends s{render(){return l(n0),this.spectrumVersion===2?it({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as p0}from"./base.js";p0("sp-icon-heart-filled",x);import{html as d0}from"./base.js";var ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var st=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(d0),this.spectrumVersion===2?ot({hidden:!this.label,title:this.label}):st({hidden:!this.label,title:this.label})}};import{defineElement as g0}from"./base.js";g0("sp-icon-open-in",C);import{html as f0}from"./base.js";var lt=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var at=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=class extends s{render(){return l(f0),this.spectrumVersion===2?lt({hidden:!this.label,title:this.label}):at({hidden:!this.label,title:this.label})}};import{defineElement as u0}from"./base.js";u0("sp-icon-share-android",$);import{html as w0}from"./base.js";var mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var ht=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var b=class extends s{render(){return l(w0),this.spectrumVersion===2?mt({hidden:!this.label,title:this.label}):ht({hidden:!this.label,title:this.label})}};import{defineElement as v0}from"./base.js";v0("sp-icon-target",b);import{html as x0}from"./base.js";var ct=({width:t=24,height:e=24,hidden:r=!1,title:i="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var nt=({width:t=24,height:e=24,hidden:r=!1,title:i="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(x0),this.spectrumVersion===2?ct({hidden:!this.label,title:this.label}):nt({hidden:!this.label,title:this.label})}};import{defineElement as C0}from"./base.js";C0("sp-icon-download",T);import{html as $0}from"./base.js";var pt=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var dt=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var I=class extends s{render(){return l($0),this.spectrumVersion===2?pt({hidden:!this.label,title:this.label}):dt({hidden:!this.label,title:this.label})}};import{defineElement as b0}from"./base.js";b0("sp-icon-cclibrary",I);import{html as T0}from"./base.js";var gt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ft=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var L=class extends s{render(){return l(T0),this.spectrumVersion===2?gt({hidden:!this.label,title:this.label}):ft({hidden:!this.label,title:this.label})}};import{defineElement as I0}from"./base.js";I0("sp-icon-chevron-down",L);import{html as L0}from"./base.js";var ut=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var wt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var Z=class extends s{render(){return l(L0),this.spectrumVersion===2?ut({hidden:!this.label,title:this.label}):wt({hidden:!this.label,title:this.label})}};import{defineElement as Z0}from"./base.js";Z0("sp-icon-chevron-left",Z);import{html as y0}from"./base.js";var vt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var xt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var y=class extends s{render(){return l(y0),this.spectrumVersion===2?vt({hidden:!this.label,title:this.label}):xt({hidden:!this.label,title:this.label})}};import{defineElement as B0}from"./base.js";B0("sp-icon-chevron-right",y);import{html as V0}from"./base.js";var Ct=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var $t=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var B=class extends s{render(){return l(V0),this.spectrumVersion===2?Ct({hidden:!this.label,title:this.label}):$t({hidden:!this.label,title:this.label})}};import{defineElement as M0}from"./base.js";M0("sp-icon-checkmark-circle",B);import{html as k0}from"./base.js";var bt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var V=class extends s{render(){return l(k0),this.spectrumVersion===2?bt({hidden:!this.label,title:this.label}):Tt({hidden:!this.label,title:this.label})}};import{defineElement as H0}from"./base.js";H0("sp-icon-close-circle",V);import{html as A0}from"./base.js";var It=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Lt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var M=class extends s{render(){return l(A0),this.spectrumVersion===2?It({hidden:!this.label,title:this.label}):Lt({hidden:!this.label,title:this.label})}};import{defineElement as E0}from"./base.js";E0("sp-icon-switch",M);import{html as z0}from"./base.js";var Zt=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var yt=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var k=class extends s{render(){return l(z0),this.spectrumVersion===2?Zt({hidden:!this.label,title:this.label}):yt({hidden:!this.label,title:this.label})}};import{defineElement as S0}from"./base.js";S0("sp-icon-add",k);import{html as D0}from"./base.js";var Bt=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Vt=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var H=class extends s{render(){return l(D0),this.spectrumVersion===2?Bt({hidden:!this.label,title:this.label}):Vt({hidden:!this.label,title:this.label})}};import{defineElement as O0}from"./base.js";O0("sp-icon-filter",H);import{html as F0}from"./base.js";var Mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch Vertical"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var A=class extends s{render(){return l(F0),this.spectrumVersion===2?Mt({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as R0}from"./base.js";R0("sp-icon-switch-vertical",A);import{html as j0}from"./base.js";var kt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Ht=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var E=class extends s{render(){return l(j0),this.spectrumVersion===2?kt({hidden:!this.label,title:this.label}):Ht({hidden:!this.label,title:this.label})}};import{defineElement as P0}from"./base.js";P0("sp-icon-close",E);import{html as N0}from"./base.js";var At=({width:t=24,height:e=24,hidden:r=!1,title:i="Accessibility"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var z=class extends s{render(){return l(N0),this.spectrumVersion===2?At({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as U0}from"./base.js";U0("sp-icon-accessibility",z);import{html as q0}from"./base.js";var Et=({width:t=24,height:e=24,hidden:r=!1,title:i="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var zt=({width:t=24,height:e=24,hidden:r=!1,title:i="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var S=class extends s{render(){return l(q0),this.spectrumVersion===2?Et({hidden:!this.label,title:this.label}):zt({hidden:!this.label,title:this.label})}};import{defineElement as G0}from"./base.js";G0("sp-icon-image",S);import{html as J0}from"./base.js";var St=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Dt=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Closed"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var D=class extends s{render(){return l(J0),this.spectrumVersion===2?St({hidden:!this.label,title:this.label}):Dt({hidden:!this.label,title:this.label})}};import{defineElement as K0}from"./base.js";K0("sp-icon-lock",D);import{html as Q0}from"./base.js";var Ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Open"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Ft=({width:t=24,height:e=24,hidden:r=!1,title:i="Lock Open"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var O=class extends s{render(){return l(Q0),this.spectrumVersion===2?Ot({hidden:!this.label,title:this.label}):Ft({hidden:!this.label,title:this.label})}};import{defineElement as W0}from"./base.js";W0("sp-icon-lock-open",O);
