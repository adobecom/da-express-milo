...
`,V=ot;var st=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,Z=(t,e,i,r)=>{for(var a=r>1?void 0:r?lt(e,i):e,L=t.length-1,I;L>=0;L--)(I=t[L])&&(a=(r?I(e,i,a):I(a))||a);return r&&a&&st(e,i,a),a},s=class extends mt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new ht(this)}static get styles(){return[V]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(ct)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return at`
  ...
  >
    ...
    />
  </svg>`;var n=class extends s{render(){return l(Y),this.spectrumVersion===2?I({hidden:!this.label,title:this.label}):Z({hidden:!this.label,title:this.label})}};import{defineElement as _}from"./base.js";_("sp-icon-edit",n);import{html as tt}from"./base.js";var z=({width:t=24,height:e=24,hidden:o=!1,title:r="Share Android"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var y=({width:t=24,height:e=24,hidden:o=!1,title:r="Share Android"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var h=class extends s{render(){return l(tt),this.spectrumVersion===2?z({hidden:!this.label,title:this.label}):y({hidden:!this.label,title:this.label})}};import{defineElement as et}from"./base.js";et("sp-icon-share-android",h);import{html as rt}from"./base.js";var B=({width:t=24,height:e=24,hidden:o=!1,title:r="Download"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var V=({width:t=24,height:e=24,hidden:o=!1,title:r="Save To"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var c=class extends s{render(){return l(rt),this.spectrumVersion===2?B({hidden:!this.label,title:this.label}):V({hidden:!this.label,title:this.label})}};import{defineElement as ot}from"./base.js";ot("sp-icon-download",c);import{html as it}from"./base.js";var A=({width:t=24,height:e=24,hidden:o=!1,title:r="CCLibrary"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var M=({width:t=24,height:e=24,hidden:o=!1,title:r="CCLibrary"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var p=class extends s{render(){return l(it),this.spectrumVersion===2?A({hidden:!this.label,title:this.label}):M({hidden:!this.label,title:this.label})}};import{defineElement as st}from"./base.js";st("sp-icon-cclibrary",p);import{html as lt}from"./base.js";var k=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Down"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var E=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Down"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var d=class extends s{render(){return l(lt),this.spectrumVersion===2?k({hidden:!this.label,title:this.label}):E({hidden:!this.label,title:this.label})}};import{defineElement as at}from"./base.js";at("sp-icon-chevron-down",d);import{html as mt}from"./base.js";var S=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Left"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var H=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Left"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(mt),this.spectrumVersion===2?S({hidden:!this.label,title:this.label}):H({hidden:!this.label,title:this.label})}};import{defineElement as nt}from"./base.js";nt("sp-icon-chevron-left",u);import{html as ht}from"./base.js";var D=({width:t=24,height:e=24,hidden:o=!1,title:r="Add"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var j=({width:t=24,height:e=24,hidden:o=!1,title:r="Add"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(ht),this.spectrumVersion===2?D({hidden:!this.label,title:this.label}):j({hidden:!this.label,title:this.label})}};import{defineElement as ct}from"./base.js";ct("sp-icon-add",f);import{html as pt}from"./base.js";var R=({width:t=24,height:e=24,hidden:o=!1,title:r="Close"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var O=({width:t=24,height:e=24,hidden:o=!1,title:r="Close"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(pt),this.spectrumVersion===2?R({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}};import{defineElement as dt}from"./base.js";dt("sp-icon-close",g);
