...
import{html as K}from"./base.js";import{html as U,SpectrumElement as q}from"./base.js";import{SystemResolutionController as F,systemResolverUpdatedSymbol as G}from"./reactive-controllers.js";import{property as b,state as J}from"./base.js";import{css as j}from"./base.js";var R=j`
...
`,C=R;var O=Object.defineProperty,P=Object.getOwnPropertyDescriptor,w=(t,e,o,r)=>{for(var l=r>1?void 0:r?P(e,o):e,g=t.length-1,v;g>=0;g--)(v=t[g])&&(l=(r?v(e,o,l):v(l))||l);return r&&l&&O(e,o,l),l},s=class extends q{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new F(this)}static get styles(){return[C]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(G)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return U`
            <slot></slot>
        `}};w([J()],s.prototype,"spectrumVersion",2),w([b({reflect:!0})],s.prototype,"label",2),w([b({reflect:!0})],s.prototype,"size",2);var x,i=function(t,...e){return x?x(t,...e):e.reduce((o,r,l)=>o+r+t[l+1],t[0])},a=t=>{x=t};var $=({width:t=24,height:e=24,hidden:o=!1,title:r="Alert"}={})=>i`<svg
  ...
  >
    ...
    />
  </svg>`;var T=({width:t=24,height:e=24,hidden:o=!1,title:r="Alert Triangle"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var m=class extends s{render(){return a(K),this.spectrumVersion===1?$({hidden:!this.label,title:this.label}):T({hidden:!this.label,title:this.label})}};import{defineElement as N}from"./base.js";N("sp-icon-alert",m);import{html as Q}from"./base.js";var L=({width:t=24,height:e=24,hidden:o=!1,title:r="Edit"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var I=({width:t=24,height:e=24,hidden:o=!1,title:r="Edit"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var n=class extends s{render(){return a(Q),this.spectrumVersion===2?L({hidden:!this.label,title:this.label}):I({hidden:!this.label,title:this.label})}};import{defineElement as W}from"./base.js";W("sp-icon-edit",n);import{html as X}from"./base.js";var z=({width:t=24,height:e=24,hidden:o=!1,title:r="Share Android"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var c=class extends s{render(){return a(X),this.spectrumVersion===2?z({hidden:!this.label,title:this.label}):Z({hidden:!this.label,title:this.label})}};import{defineElement as Y}from"./base.js";Y("sp-icon-share-android",c);import{html as _}from"./base.js";var y=({width:t=24,height:e=24,hidden:o=!1,title:r="Download"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var h=class extends s{render(){return a(_),this.spectrumVersion===2?y({hidden:!this.label,title:this.label}):V({hidden:!this.label,title:this.label})}};import{defineElement as tt}from"./base.js";tt("sp-icon-download",h);import{html as et}from"./base.js";var A=({width:t=24,height:e=24,hidden:o=!1,title:r="CCLibrary"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var d=class extends s{render(){return a(et),this.spectrumVersion===2?A({hidden:!this.label,title:this.label}):B({hidden:!this.label,title:this.label})}};import{defineElement as rt}from"./base.js";rt("sp-icon-cclibrary",d);import{html as ot}from"./base.js";var M=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Down"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var k=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Down"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var p=class extends s{render(){return a(ot),this.spectrumVersion===2?M({hidden:!this.label,title:this.label}):k({hidden:!this.label,title:this.label})}};import{defineElement as it}from"./base.js";it("sp-icon-chevron-down",p);import{html as st}from"./base.js";var S=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Left"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var E=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Left"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return a(st),this.spectrumVersion===2?S({hidden:!this.label,title:this.label}):E({hidden:!this.label,title:this.label})}};import{defineElement as at}from"./base.js";at("sp-icon-chevron-left",u);import{html as lt}from"./base.js";var H=({width:t=24,height:e=24,hidden:o=!1,title:r="Add"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var D=({width:t=24,height:e=24,hidden:o=!1,title:r="Add"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return a(lt),this.spectrumVersion===2?H({hidden:!this.label,title:this.label}):D({hidden:!this.label,title:this.label})}};import{defineElement as mt}from"./base.js";mt("sp-icon-add",f);
