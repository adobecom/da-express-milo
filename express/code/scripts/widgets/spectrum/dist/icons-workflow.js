...
`,z=dt;var gt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,V=(t,e,i,r)=>{for(var a=r>1?void 0:r?ft(e,i):e,B=t.length-1,k;B>=0;B--)(k=t[B])&&(a=(r?k(e,i,a):k(a))||a);return r&&a&&gt(e,i,a),a},s=class extends wt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new vt(this)}static get styles(){return[z]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(xt)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return ut`
            <slot></slot>
        `}};V([Ct()],s.prototype,"spectrumVersion",2),V([A({reflect:!0})],s.prototype,"label",2),V([A({reflect:!0})],s.prototype,"size",2);var M,o=function(t,...e){return M?M(t,...e):e.reduce((i,r,a)=>i+r+t[a+1],t[0])},l=t=>{M=t};var m=({width:t=24,height:e=24,hidden:i=!1,title:r="Alert"}={})=>o`<svg
  ...
  </svg>`;var p=class extends s{render(){return l(It),this.spectrumVersion===2?H({hidden:!this.label,title:this.label}):E({hidden:!this.label,title:this.label})}};import{defineElement as Zt}from"./base.js";Zt("sp-icon-circle",p);import{html as yt}from"./base.js";var S=({width:t=24,height:e=24,hidden:i=!1,title:r="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var d=class extends s{render(){return l(yt),this.spectrumVersion===2?S({hidden:!this.label,title:this.label}):D({hidden:!this.label,title:this.label})}};import{defineElement as Bt}from"./base.js";Bt("sp-icon-copy",d);import{html as kt}from"./base.js";var O=({width:t=24,height:e=24,hidden:i=!1,title:r="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(kt),this.spectrumVersion===2?O({hidden:!this.label,title:this.label}):j({hidden:!this.label,title:this.label})}};import{defineElement as Vt}from"./base.js";Vt("sp-icon-delete",g);import{html as Mt}from"./base.js";var R=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var F=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(Mt),this.spectrumVersion===2?R({hidden:!this.label,title:this.label}):F({hidden:!this.label,title:this.label})}};import{defineElement as zt}from"./base.js";zt("sp-icon-edit",f);import{html as At}from"./base.js";var P=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(At),this.spectrumVersion===2?P({hidden:!this.label,title:this.label}):U({hidden:!this.label,title:this.label})}};import{defineElement as Ht}from"./base.js";Ht("sp-icon-share-android",u);import{html as Et}from"./base.js";var q=({width:t=24,height:e=24,hidden:i=!1,title:r="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var w=class extends s{render(){return l(Et),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):G({hidden:!this.label,title:this.label})}};import{defineElement as St}from"./base.js";St("sp-icon-target",w);import{html as Dt}from"./base.js";var J=({width:t=24,height:e=24,hidden:i=!1,title:r="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(Dt),this.spectrumVersion===2?J({hidden:!this.label,title:this.label}):K({hidden:!this.label,title:this.label})}};import{defineElement as Ot}from"./base.js";Ot("sp-icon-download",v);import{html as jt}from"./base.js";var N=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(jt),this.spectrumVersion===2?N({hidden:!this.label,title:this.label}):Q({hidden:!this.label,title:this.label})}};import{defineElement as Rt}from"./base.js";Rt("sp-icon-cclibrary",x);import{html as Ft}from"./base.js";var W=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(Ut),this.spectrumVersion===2?Y({hidden:!this.label,title:this.label}):_({hidden:!this.label,title:this.label})}};import{defineElement as qt}from"./base.js";qt("sp-icon-chevron-left",b);import{html as Gt}from"./base.js";var tt=({width:t=24,height:e=24,hidden:i=!1,title:r="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var et=({width:t=24,height:e=24,hidden:i=!1,title:r="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=class extends s{render(){return l(Gt),this.spectrumVersion===2?tt({hidden:!this.label,title:this.label}):et({hidden:!this.label,title:this.label})}};import{defineElement as Jt}from"./base.js";Jt("sp-icon-add",$);import{html as Kt}from"./base.js";var rt=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var it=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(Kt),this.spectrumVersion===2?rt({hidden:!this.label,title:this.label}):it({hidden:!this.label,title:this.label})}};import{defineElement as Nt}from"./base.js";Nt("sp-icon-close",T);import{html as Qt}from"./base.js";var ot=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var st=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var L=class extends s{render(){return l(Qt),this.spectrumVersion===2?ot({hidden:!this.label,title:this.label}):st({hidden:!this.label,title:this.label})}};import{defineElement as Wt}from"./base.js";Wt("sp-icon-checkmark-circle",L);import{html as Xt}from"./base.js";var lt=({width:t=24,height:e=24,hidden:i=!1,title:r="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var at=({width:t=24,height:e=24,hidden:i=!1,title:r="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var I=class extends s{render(){return l(Xt),this.spectrumVersion===2?lt({hidden:!this.label,title:this.label}):at({hidden:!this.label,title:this.label})}};import{defineElement as Yt}from"./base.js";Yt("sp-icon-image",I);import{html as _t}from"./base.js";var mt=({width:t=24,height:e=24,hidden:i=!1,title:r="Lock"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ht=({width:t=24,height:e=24,hidden:i=!1,title:r="Lock Closed"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var Z=class extends s{render(){return l(_t),this.spectrumVersion===2?mt({hidden:!this.label,title:this.label}):ht({hidden:!this.label,title:this.label})}};import{defineElement as te}from"./base.js";te("sp-icon-lock",Z);import{html as ee}from"./base.js";var ct=({width:t=24,height:e=24,hidden:i=!1,title:r="Lock Open"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var nt=({width:t=24,height:e=24,hidden:i=!1,title:r="Lock Open"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var y=class extends s{render(){return l(ee),this.spectrumVersion===2?ct({hidden:!this.label,title:this.label}):nt({hidden:!this.label,title:this.label})}};import{defineElement as re}from"./base.js";re("sp-icon-lock-open",y);
