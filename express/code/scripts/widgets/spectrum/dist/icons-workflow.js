...
import{html as Zt}from"./base.js";import{html as bt,SpectrumElement as $t}from"./base.js";import{SystemResolutionController as Tt,systemResolverUpdatedSymbol as It}from"./reactive-controllers.js";import{property as S,state as Lt}from"./base.js";import{css as wt}from"./base.js";var vt=wt`
...
`,E=vt;var xt=Object.defineProperty,Ct=Object.getOwnPropertyDescriptor,A=(t,e,r,i)=>{for(var a=i>1?void 0:i?Ct(e,r):e,k=t.length-1,H;k>=0;k--)(H=t[k])&&(a=(i?H(e,r,a):H(a))||a);return i&&a&&xt(e,r,a),a},s=class extends $t{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new Tt(this)}static get styles(){return[E]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(It)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return bt`
            <slot></slot>
        `}};A([Lt()],s.prototype,"spectrumVersion",2),A([S({reflect:!0})],s.prototype,"label",2),A([S({reflect:!0})],s.prototype,"size",2);var z,o=function(t,...e){return z?z(t,...e):e.reduce((r,i,a)=>r+i+t[a+1],t[0])},l=t=>{z=t};var m=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert"}={})=>o`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var c=class extends s{render(){return l(Zt),this.spectrumVersion===1?m({hidden:!this.label,title:this.label}):h({hidden:!this.label,title:this.label})}};import{defineElement as yt}from"./base.js";yt("sp-icon-alert",c);import{html as Bt}from"./base.js";var n=class extends s{render(){return l(Bt),this.spectrumVersion===2?h({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as Vt}from"./base.js";Vt("sp-icon-alert-triangle",n);import{html as Mt}from"./base.js";var D=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var F=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle Filled"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var p=class extends s{render(){return l(Mt),this.spectrumVersion===2?D({hidden:!this.label,title:this.label}):F({hidden:!this.label,title:this.label})}};import{defineElement as kt}from"./base.js";kt("sp-icon-circle",p);import{html as Ht}from"./base.js";var O=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var d=class extends s{render(){return l(Ht),this.spectrumVersion===2?O({hidden:!this.label,title:this.label}):j({hidden:!this.label,title:this.label})}};import{defineElement as At}from"./base.js";At("sp-icon-copy",d);import{html as zt}from"./base.js";var R=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var P=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(zt),this.spectrumVersion===2?R({hidden:!this.label,title:this.label}):P({hidden:!this.label,title:this.label})}};import{defineElement as Et}from"./base.js";Et("sp-icon-delete",g);import{html as St}from"./base.js";var N=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var U=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(St),this.spectrumVersion===2?N({hidden:!this.label,title:this.label}):U({hidden:!this.label,title:this.label})}};import{defineElement as Dt}from"./base.js";Dt("sp-icon-edit",f);import{html as Ft}from"./base.js";var q=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var G=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(Ft),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):G({hidden:!this.label,title:this.label})}};import{defineElement as Ot}from"./base.js";Ot("sp-icon-heart",u);import{html as jt}from"./base.js";var J=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart Filled"}={})=>o`<svg
    data-name="ICONS"
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
  ...
  >
    ...
    `;var v=class extends s{render(){return l(jt),this.spectrumVersion===2?J({hidden:!this.label,title:this.label}):w({hidden:!this.label,title:this.label})}};import{defineElement as Rt}from"./base.js";Rt("sp-icon-heart-filled",v);import{html as Pt}from"./base.js";var K=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Q=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(Pt),this.spectrumVersion===2?K({hidden:!this.label,title:this.label}):Q({hidden:!this.label,title:this.label})}};import{defineElement as Nt}from"./base.js";Nt("sp-icon-open-in",x);import{html as Ut}from"./base.js";var W=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var X=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(Ut),this.spectrumVersion===2?W({hidden:!this.label,title:this.label}):X({hidden:!this.label,title:this.label})}};import{defineElement as qt}from"./base.js";qt("sp-icon-share-android",C);import{html as Gt}from"./base.js";var Y=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var _=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var b=class extends s{render(){return l(Gt),this.spectrumVersion===2?Y({hidden:!this.label,title:this.label}):_({hidden:!this.label,title:this.label})}};import{defineElement as Jt}from"./base.js";Jt("sp-icon-target",b);import{html as Kt}from"./base.js";var tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var et=({width:t=24,height:e=24,hidden:r=!1,title:i="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=class extends s{render(){return l(Kt),this.spectrumVersion===2?tt({hidden:!this.label,title:this.label}):et({hidden:!this.label,title:this.label})}};import{defineElement as Qt}from"./base.js";Qt("sp-icon-download",$);import{html as Wt}from"./base.js";var rt=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var it=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(Wt),this.spectrumVersion===2?rt({hidden:!this.label,title:this.label}):it({hidden:!this.label,title:this.label})}};import{defineElement as Xt}from"./base.js";Xt("sp-icon-cclibrary",T);import{html as Yt}from"./base.js";var ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var st=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var I=class extends s{render(){return l(Yt),this.spectrumVersion===2?ot({hidden:!this.label,title:this.label}):st({hidden:!this.label,title:this.label})}};import{defineElement as _t}from"./base.js";_t("sp-icon-chevron-down",I);import{html as te}from"./base.js";var lt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var at=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var L=class extends s{render(){return l(te),this.spectrumVersion===2?lt({hidden:!this.label,title:this.label}):at({hidden:!this.label,title:this.label})}};import{defineElement as ee}from"./base.js";ee("sp-icon-chevron-left",L);import{html as re}from"./base.js";var mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ht=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var Z=class extends s{render(){return l(re),this.spectrumVersion===2?mt({hidden:!this.label,title:this.label}):ht({hidden:!this.label,title:this.label})}};import{defineElement as ie}from"./base.js";ie("sp-icon-add",Z);import{html as oe}from"./base.js";var ct=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var nt=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var y=class extends s{render(){return l(oe),this.spectrumVersion===2?ct({hidden:!this.label,title:this.label}):nt({hidden:!this.label,title:this.label})}};import{defineElement as se}from"./base.js";se("sp-icon-filter",y);import{html as le}from"./base.js";var pt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch Vertical"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var B=class extends s{render(){return l(le),this.spectrumVersion===2?pt({hidden:!this.label,title:this.label}):w({hidden:!this.label,title:this.label})}};import{defineElement as ae}from"./base.js";ae("sp-icon-switch-vertical",B);import{html as me}from"./base.js";var dt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var gt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var V=class extends s{render(){return l(me),this.spectrumVersion===2?dt({hidden:!this.label,title:this.label}):gt({hidden:!this.label,title:this.label})}};import{defineElement as he}from"./base.js";he("sp-icon-close",V);import{html as ce}from"./base.js";var ft=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ut=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var M=class extends s{render(){return l(ce),this.spectrumVersion===2?ft({hidden:!this.label,title:this.label}):ut({hidden:!this.label,title:this.label})}};import{defineElement as ne}from"./base.js";ne("sp-icon-checkmark-circle",M);
