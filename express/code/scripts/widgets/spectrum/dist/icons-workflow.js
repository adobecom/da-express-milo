...
import{html as St}from"./base.js";import{html as Mt,SpectrumElement as Ht}from"./base.js";import{SystemResolutionController as kt,systemResolverUpdatedSymbol as At}from"./reactive-controllers.js";import{property as O,state as zt}from"./base.js";import{css as Zt}from"./base.js";var yt=Zt`
...
`,F=yt;var Bt=Object.defineProperty,Vt=Object.getOwnPropertyDescriptor,E=(t,e,r,i)=>{for(var a=i>1?void 0:i?Vt(e,r):e,z=t.length-1,S;z>=0;z--)(S=t[z])&&(a=(i?S(e,r,a):S(a))||a);return i&&a&&Bt(e,r,a),a},s=class extends Ht{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new kt(this)}static get styles(){return[F]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(At)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return Mt`
            <slot></slot>
        `}};E([zt()],s.prototype,"spectrumVersion",2),E([O({reflect:!0})],s.prototype,"label",2),E([O({reflect:!0})],s.prototype,"size",2);var D,o=function(t,...e){return D?D(t,...e):e.reduce((r,i,a)=>r+i+t[a+1],t[0])},l=t=>{D=t};var m=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert"}={})=>o`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var c=class extends s{render(){return l(St),this.spectrumVersion===1?m({hidden:!this.label,title:this.label}):h({hidden:!this.label,title:this.label})}};import{defineElement as Et}from"./base.js";Et("sp-icon-alert",c);import{html as Dt}from"./base.js";var n=class extends s{render(){return l(Dt),this.spectrumVersion===2?h({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as Ft}from"./base.js";Ft("sp-icon-alert-triangle",n);import{html as Ot}from"./base.js";var R=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var j=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle Filled"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var p=class extends s{render(){return l(Ot),this.spectrumVersion===2?R({hidden:!this.label,title:this.label}):j({hidden:!this.label,title:this.label})}};import{defineElement as Rt}from"./base.js";Rt("sp-icon-circle",p);import{html as jt}from"./base.js";var P=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var N=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var d=class extends s{render(){return l(jt),this.spectrumVersion===2?P({hidden:!this.label,title:this.label}):N({hidden:!this.label,title:this.label})}};import{defineElement as Pt}from"./base.js";Pt("sp-icon-copy",d);import{html as Nt}from"./base.js";var U=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(Nt),this.spectrumVersion===2?U({hidden:!this.label,title:this.label}):q({hidden:!this.label,title:this.label})}};import{defineElement as Ut}from"./base.js";Ut("sp-icon-delete",g);import{html as qt}from"./base.js";var G=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(qt),this.spectrumVersion===2?G({hidden:!this.label,title:this.label}):J({hidden:!this.label,title:this.label})}};import{defineElement as Gt}from"./base.js";Gt("sp-icon-edit",f);import{html as Jt}from"./base.js";var K=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(Jt),this.spectrumVersion===2?K({hidden:!this.label,title:this.label}):Q({hidden:!this.label,title:this.label})}};import{defineElement as Kt}from"./base.js";Kt("sp-icon-heart",u);import{html as Qt}from"./base.js";var W=({width:t=24,height:e=24,hidden:r=!1,title:i="Heart Filled"}={})=>o`<svg
    data-name="ICONS"
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
  ...
  >
    ...
    `;var v=class extends s{render(){return l(Qt),this.spectrumVersion===2?W({hidden:!this.label,title:this.label}):w({hidden:!this.label,title:this.label})}};import{defineElement as Wt}from"./base.js";Wt("sp-icon-heart-filled",v);import{html as Xt}from"./base.js";var X=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Y=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(Xt),this.spectrumVersion===2?X({hidden:!this.label,title:this.label}):Y({hidden:!this.label,title:this.label})}};import{defineElement as Yt}from"./base.js";Yt("sp-icon-open-in",x);import{html as _t}from"./base.js";var _=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(_t),this.spectrumVersion===2?_({hidden:!this.label,title:this.label}):tt({hidden:!this.label,title:this.label})}};import{defineElement as te}from"./base.js";te("sp-icon-share-android",C);import{html as ee}from"./base.js";var et=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var rt=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var $=class extends s{render(){return l(ee),this.spectrumVersion===2?et({hidden:!this.label,title:this.label}):rt({hidden:!this.label,title:this.label})}};import{defineElement as re}from"./base.js";re("sp-icon-target",$);import{html as ie}from"./base.js";var it=({width:t=24,height:e=24,hidden:r=!1,title:i="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(ie),this.spectrumVersion===2?it({hidden:!this.label,title:this.label}):ot({hidden:!this.label,title:this.label})}};import{defineElement as oe}from"./base.js";oe("sp-icon-download",b);import{html as se}from"./base.js";var st=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var lt=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(se),this.spectrumVersion===2?st({hidden:!this.label,title:this.label}):lt({hidden:!this.label,title:this.label})}};import{defineElement as le}from"./base.js";le("sp-icon-cclibrary",T);import{html as ae}from"./base.js";var at=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var I=class extends s{render(){return l(ae),this.spectrumVersion===2?at({hidden:!this.label,title:this.label}):mt({hidden:!this.label,title:this.label})}};import{defineElement as me}from"./base.js";me("sp-icon-chevron-down",I);import{html as he}from"./base.js";var ht=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ct=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var L=class extends s{render(){return l(he),this.spectrumVersion===2?ht({hidden:!this.label,title:this.label}):ct({hidden:!this.label,title:this.label})}};import{defineElement as ce}from"./base.js";ce("sp-icon-chevron-left",L);import{html as ne}from"./base.js";var nt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var pt=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var Z=class extends s{render(){return l(ne),this.spectrumVersion===2?nt({hidden:!this.label,title:this.label}):pt({hidden:!this.label,title:this.label})}};import{defineElement as pe}from"./base.js";pe("sp-icon-chevron-right",Z);import{html as de}from"./base.js";var dt=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var y=class extends s{render(){return l(de),this.spectrumVersion===2?dt({hidden:!this.label,title:this.label}):gt({hidden:!this.label,title:this.label})}};import{defineElement as ge}from"./base.js";ge("sp-icon-checkmark-circle",y);import{html as fe}from"./base.js";var ft=({width:t=24,height:e=24,hidden:r=!1,title:i="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var ut=({width:t=24,height:e=24,hidden:r=!1,title:i="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var B=class extends s{render(){return l(fe),this.spectrumVersion===2?ft({hidden:!this.label,title:this.label}):ut({hidden:!this.label,title:this.label})}};import{defineElement as ue}from"./base.js";ue("sp-icon-close-circle",B);import{html as we}from"./base.js";var wt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var vt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var V=class extends s{render(){return l(we),this.spectrumVersion===2?wt({hidden:!this.label,title:this.label}):vt({hidden:!this.label,title:this.label})}};import{defineElement as ve}from"./base.js";ve("sp-icon-switch",V);import{html as xe}from"./base.js";var xt=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Ct=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var M=class extends s{render(){return l(xe),this.spectrumVersion===2?xt({hidden:!this.label,title:this.label}):Ct({hidden:!this.label,title:this.label})}};import{defineElement as Ce}from"./base.js";Ce("sp-icon-add",M);import{html as $e}from"./base.js";var $t=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var bt=({width:t=24,height:e=24,hidden:r=!1,title:i="Filter"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var H=class extends s{render(){return l($e),this.spectrumVersion===2?$t({hidden:!this.label,title:this.label}):bt({hidden:!this.label,title:this.label})}};import{defineElement as be}from"./base.js";be("sp-icon-filter",H);import{html as Te}from"./base.js";var Tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Switch Vertical"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var k=class extends s{render(){return l(Te),this.spectrumVersion===2?Tt({hidden:!this.label,title:this.label}):w({hidden:!this.label,title:this.label})}};import{defineElement as Ie}from"./base.js";Ie("sp-icon-switch-vertical",k);import{html as Le}from"./base.js";var It=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Lt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var A=class extends s{render(){return l(Le),this.spectrumVersion===2?It({hidden:!this.label,title:this.label}):Lt({hidden:!this.label,title:this.label})}};import{defineElement as Ze}from"./base.js";Ze("sp-icon-close",A);
