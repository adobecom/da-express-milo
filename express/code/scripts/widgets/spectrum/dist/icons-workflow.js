...
import{html as bt}from"./base.js";import{html as ut,SpectrumElement as wt}from"./base.js";import{SystemResolutionController as vt,systemResolverUpdatedSymbol as xt}from"./reactive-controllers.js";import{property as z,state as Ct}from"./base.js";import{css as pt}from"./base.js";var dt=pt`
...
`,k=dt;var gt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,M=(t,e,r,i)=>{for(var a=i>1?void 0:i?ft(e,r):e,B=t.length-1,V;B>=0;B--)(V=t[B])&&(a=(i?V(e,r,a):V(a))||a);return i&&a&&gt(e,r,a),a},s=class extends wt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new vt(this)}static get styles(){return[k]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(xt)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return ut`
            <slot></slot>
        `}};M([Ct()],s.prototype,"spectrumVersion",2),M([z({reflect:!0})],s.prototype,"label",2),M([z({reflect:!0})],s.prototype,"size",2);var A,o=function(t,...e){return A?A(t,...e):e.reduce((r,i,a)=>r+i+t[a+1],t[0])},l=t=>{A=t};var m=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert"}={})=>o`<svg
  ...
  >
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var H=({width:t=24,height:e=24,hidden:r=!1,title:i="Circle Filled"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var p=class extends s{render(){return l(Zt),this.spectrumVersion===2?E({hidden:!this.label,title:this.label}):H({hidden:!this.label,title:this.label})}};import{defineElement as Lt}from"./base.js";Lt("sp-icon-circle",p);import{html as yt}from"./base.js";var S=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var D=({width:t=24,height:e=24,hidden:r=!1,title:i="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var d=class extends s{render(){return l(yt),this.spectrumVersion===2?S({hidden:!this.label,title:this.label}):D({hidden:!this.label,title:this.label})}};import{defineElement as Bt}from"./base.js";Bt("sp-icon-copy",d);import{html as Vt}from"./base.js";var j=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var R=({width:t=24,height:e=24,hidden:r=!1,title:i="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(Vt),this.spectrumVersion===2?j({hidden:!this.label,title:this.label}):R({hidden:!this.label,title:this.label})}};import{defineElement as Mt}from"./base.js";Mt("sp-icon-delete",g);import{html as At}from"./base.js";var F=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var O=({width:t=24,height:e=24,hidden:r=!1,title:i="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(At),this.spectrumVersion===2?F({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}};import{defineElement as kt}from"./base.js";kt("sp-icon-edit",f);import{html as zt}from"./base.js";var W=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var P=({width:t=24,height:e=24,hidden:r=!1,title:i="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(zt),this.spectrumVersion===2?W({hidden:!this.label,title:this.label}):P({hidden:!this.label,title:this.label})}};import{defineElement as Et}from"./base.js";Et("sp-icon-share-android",u);import{html as Ht}from"./base.js";var U=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var q=({width:t=24,height:e=24,hidden:r=!1,title:i="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var w=class extends s{render(){return l(Ht),this.spectrumVersion===2?U({hidden:!this.label,title:this.label}):q({hidden:!this.label,title:this.label})}};import{defineElement as St}from"./base.js";St("sp-icon-target",w);import{html as Dt}from"./base.js";var G=({width:t=24,height:e=24,hidden:r=!1,title:i="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(Dt),this.spectrumVersion===2?G({hidden:!this.label,title:this.label}):J({hidden:!this.label,title:this.label})}};import{defineElement as jt}from"./base.js";jt("sp-icon-download",v);import{html as Rt}from"./base.js";var K=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var N=({width:t=24,height:e=24,hidden:r=!1,title:i="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(Rt),this.spectrumVersion===2?K({hidden:!this.label,title:this.label}):N({hidden:!this.label,title:this.label})}};import{defineElement as Ft}from"./base.js";Ft("sp-icon-cclibrary",x);import{html as Ot}from"./base.js";var Q=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var X=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(Ot),this.spectrumVersion===2?Q({hidden:!this.label,title:this.label}):X({hidden:!this.label,title:this.label})}};import{defineElement as Wt}from"./base.js";Wt("sp-icon-chevron-down",C);import{html as Pt}from"./base.js";var Y=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var _=({width:t=24,height:e=24,hidden:r=!1,title:i="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(Pt),this.spectrumVersion===2?Y({hidden:!this.label,title:this.label}):_({hidden:!this.label,title:this.label})}};import{defineElement as Ut}from"./base.js";Ut("sp-icon-chevron-left",b);import{html as qt}from"./base.js";var tt=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var et=({width:t=24,height:e=24,hidden:r=!1,title:i="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=class extends s{render(){return l(qt),this.spectrumVersion===2?tt({hidden:!this.label,title:this.label}):et({hidden:!this.label,title:this.label})}};import{defineElement as Gt}from"./base.js";Gt("sp-icon-add",$);import{html as Jt}from"./base.js";var rt=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var it=({width:t=24,height:e=24,hidden:r=!1,title:i="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(Jt),this.spectrumVersion===2?rt({hidden:!this.label,title:this.label}):it({hidden:!this.label,title:this.label})}};import{defineElement as Kt}from"./base.js";Kt("sp-icon-close",T);import{html as Nt}from"./base.js";var ot=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var st=({width:t=24,height:e=24,hidden:r=!1,title:i="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var I=class extends s{render(){return l(Nt),this.spectrumVersion===2?ot({hidden:!this.label,title:this.label}):st({hidden:!this.label,title:this.label})}};import{defineElement as Qt}from"./base.js";Qt("sp-icon-checkmark-circle",I);import{html as Xt}from"./base.js";var lt=({width:t=24,height:e=24,hidden:r=!1,title:i="Sampler"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Z=class extends s{render(){return l(Xt),this.spectrumVersion===1?lt({hidden:!this.label,title:this.label}):at({hidden:!this.label,title:this.label})}};import{defineElement as Yt}from"./base.js";Yt("sp-icon-sampler",Z);import{html as _t}from"./base.js";var mt=({width:t=24,height:e=24,hidden:r=!1,title:i="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  </svg>`;var L=class extends s{render(){return l(_t),this.spectrumVersion===2?mt({hidden:!this.label,title:this.label}):ht({hidden:!this.label,title:this.label})}};import{defineElement as te}from"./base.js";te("sp-icon-image",L);import{html as ee}from"./base.js";var ct=({width:t=24,height:e=24,hidden:r=!1,title:i="Color Wheel"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var nt=({width:t=24,height:e=24,hidden:r=!1,title:i="Default"}={})=>o`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            role="img"
    ...
    `;var y=class extends s{render(){return l(ee),this.spectrumVersion===1?ct({hidden:!this.label,title:this.label}):nt({hidden:!this.label,title:this.label})}};import{defineElement as re}from"./base.js";re("sp-icon-color-wheel",y);
