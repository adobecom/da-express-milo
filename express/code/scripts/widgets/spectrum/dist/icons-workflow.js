...
import{html as bt}from"./base.js";import{html as ut,SpectrumElement as wt}from"./base.js";import{SystemResolutionController as vt,systemResolverUpdatedSymbol as xt}from"./reactive-controllers.js";import{property as A,state as Ct}from"./base.js";import{css as pt}from"./base.js";var dt=pt`
...
`,z=dt;var gt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,M=(t,e,i,r)=>{for(var a=r>1?void 0:r?ft(e,i):e,B=t.length-1,V;B>=0;B--)(V=t[B])&&(a=(r?V(e,i,a):V(a))||a);return r&&a&&gt(e,i,a),a},s=class extends wt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new vt(this)}static get styles(){return[z]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(xt)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return ut`
            <slot></slot>
        `}};M([Ct()],s.prototype,"spectrumVersion",2),M([A({reflect:!0})],s.prototype,"label",2),M([A({reflect:!0})],s.prototype,"size",2);var k,o=function(t,...e){return k?k(t,...e):e.reduce((i,r,a)=>i+r+t[a+1],t[0])},l=t=>{k=t};var m=({width:t=24,height:e=24,hidden:i=!1,title:r="Alert"}={})=>o`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var c=class extends s{render(){return l(bt),this.spectrumVersion===1?m({hidden:!this.label,title:this.label}):h({hidden:!this.label,title:this.label})}};import{defineElement as $t}from"./base.js";$t("sp-icon-alert",c);import{html as Tt}from"./base.js";var n=class extends s{render(){return l(Tt),this.spectrumVersion===2?h({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as Lt}from"./base.js";Lt("sp-icon-alert-triangle",n);import{html as It}from"./base.js";var S=({width:t=24,height:e=24,hidden:i=!1,title:r="Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var E=({width:t=24,height:e=24,hidden:i=!1,title:r="Circle Filled"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var p=class extends s{render(){return l(It),this.spectrumVersion===2?S({hidden:!this.label,title:this.label}):E({hidden:!this.label,title:this.label})}};import{defineElement as Zt}from"./base.js";Zt("sp-icon-circle",p);import{html as yt}from"./base.js";var H=({width:t=24,height:e=24,hidden:i=!1,title:r="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var D=({width:t=24,height:e=24,hidden:i=!1,title:r="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var d=class extends s{render(){return l(yt),this.spectrumVersion===2?H({hidden:!this.label,title:this.label}):D({hidden:!this.label,title:this.label})}};import{defineElement as Bt}from"./base.js";Bt("sp-icon-copy",d);import{html as Vt}from"./base.js";var R=({width:t=24,height:e=24,hidden:i=!1,title:r="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var j=({width:t=24,height:e=24,hidden:i=!1,title:r="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(Vt),this.spectrumVersion===2?R({hidden:!this.label,title:this.label}):j({hidden:!this.label,title:this.label})}};import{defineElement as Mt}from"./base.js";Mt("sp-icon-delete",g);import{html as kt}from"./base.js";var F=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var O=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(kt),this.spectrumVersion===2?F({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}};import{defineElement as zt}from"./base.js";zt("sp-icon-edit",f);import{html as At}from"./base.js";var P=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var U=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(At),this.spectrumVersion===2?P({hidden:!this.label,title:this.label}):U({hidden:!this.label,title:this.label})}};import{defineElement as St}from"./base.js";St("sp-icon-share-android",u);import{html as Et}from"./base.js";var q=({width:t=24,height:e=24,hidden:i=!1,title:r="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var G=({width:t=24,height:e=24,hidden:i=!1,title:r="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var w=class extends s{render(){return l(Et),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):G({hidden:!this.label,title:this.label})}};import{defineElement as Ht}from"./base.js";Ht("sp-icon-target",w);import{html as Dt}from"./base.js";var J=({width:t=24,height:e=24,hidden:i=!1,title:r="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var K=({width:t=24,height:e=24,hidden:i=!1,title:r="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(Dt),this.spectrumVersion===2?J({hidden:!this.label,title:this.label}):K({hidden:!this.label,title:this.label})}};import{defineElement as Rt}from"./base.js";Rt("sp-icon-download",v);import{html as jt}from"./base.js";var N=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Q=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(jt),this.spectrumVersion===2?N({hidden:!this.label,title:this.label}):Q({hidden:!this.label,title:this.label})}};import{defineElement as Ft}from"./base.js";Ft("sp-icon-cclibrary",x);import{html as Ot}from"./base.js";var W=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var X=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(Ot),this.spectrumVersion===2?W({hidden:!this.label,title:this.label}):X({hidden:!this.label,title:this.label})}};import{defineElement as Pt}from"./base.js";Pt("sp-icon-chevron-down",C);import{html as Ut}from"./base.js";var Y=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var _=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(Ut),this.spectrumVersion===2?Y({hidden:!this.label,title:this.label}):_({hidden:!this.label,title:this.label})}};import{defineElement as qt}from"./base.js";qt("sp-icon-chevron-left",b);import{html as Gt}from"./base.js";var tt=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var et=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Right"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=class extends s{render(){return l(Gt),this.spectrumVersion===2?tt({hidden:!this.label,title:this.label}):et({hidden:!this.label,title:this.label})}};import{defineElement as Jt}from"./base.js";Jt("sp-icon-chevron-right",$);import{html as Kt}from"./base.js";var rt=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var it=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(Kt),this.spectrumVersion===2?rt({hidden:!this.label,title:this.label}):it({hidden:!this.label,title:this.label})}};import{defineElement as Nt}from"./base.js";Nt("sp-icon-checkmark-circle",T);import{html as Qt}from"./base.js";var ot=({width:t=24,height:e=24,hidden:i=!1,title:r="Close Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var nt=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var y=class extends s{render(){return l(ee),this.spectrumVersion===2?ct({hidden:!this.label,title:this.label}):nt({hidden:!this.label,title:this.label})}};import{defineElement as re}from"./base.js";re("sp-icon-close",y);
