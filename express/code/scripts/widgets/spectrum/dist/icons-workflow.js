...
import{html as ft}from"./base.js";import{html as ct,SpectrumElement as nt}from"./base.js";import{SystemResolutionController as pt,systemResolverUpdatedSymbol as dt}from"./reactive-controllers.js";import{property as z,state as gt}from"./base.js";import{css as lt}from"./base.js";var at=lt`
...
`,k=at;var mt=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,B=(t,e,i,r)=>{for(var a=r>1?void 0:r?ht(e,i):e,y=t.length-1,Z;y>=0;y--)(Z=t[y])&&(a=(r?Z(e,i,a):Z(a))||a);return r&&a&&mt(e,i,a),a},s=class extends nt{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new pt(this)}static get styles(){return[k]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(dt)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return ct`
            <slot></slot>
        `}};B([gt()],s.prototype,"spectrumVersion",2),B([z({reflect:!0})],s.prototype,"label",2),B([z({reflect:!0})],s.prototype,"size",2);var V,o=function(t,...e){return V?V(t,...e):e.reduce((i,r,a)=>i+r+t[a+1],t[0])},l=t=>{V=t};var m=({width:t=24,height:e=24,hidden:i=!1,title:r="Alert"}={})=>o`<svg
  ...
  </svg>`;var p=class extends s{render(){return l(xt),this.spectrumVersion===2?M({hidden:!this.label,title:this.label}):A({hidden:!this.label,title:this.label})}};import{defineElement as Ct}from"./base.js";Ct("sp-icon-circle",p);import{html as bt}from"./base.js";var E=({width:t=24,height:e=24,hidden:i=!1,title:r="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var H=({width:t=24,height:e=24,hidden:i=!1,title:r="Copy"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var d=class extends s{render(){return l(bt),this.spectrumVersion===2?E({hidden:!this.label,title:this.label}):H({hidden:!this.label,title:this.label})}};import{defineElement as $t}from"./base.js";$t("sp-icon-copy",d);import{html as Tt}from"./base.js";var S=({width:t=24,height:e=24,hidden:i=!1,title:r="Delete"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(Tt),this.spectrumVersion===2?S({hidden:!this.label,title:this.label}):D({hidden:!this.label,title:this.label})}};import{defineElement as It}from"./base.js";It("sp-icon-delete",g);import{html as Lt}from"./base.js";var j=({width:t=24,height:e=24,hidden:i=!1,title:r="Edit"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(Lt),this.spectrumVersion===2?j({hidden:!this.label,title:this.label}):R({hidden:!this.label,title:this.label})}};import{defineElement as yt}from"./base.js";yt("sp-icon-edit",f);import{html as Zt}from"./base.js";var F=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var O=({width:t=24,height:e=24,hidden:i=!1,title:r="Share Android"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(Zt),this.spectrumVersion===2?F({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}};import{defineElement as Bt}from"./base.js";Bt("sp-icon-share-android",u);import{html as Vt}from"./base.js";var P=({width:t=24,height:e=24,hidden:i=!1,title:r="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      stroke-width="0"
    />
  </svg>`;var U=({width:t=24,height:e=24,hidden:i=!1,title:r="Target"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var w=class extends s{render(){return l(Vt),this.spectrumVersion===2?P({hidden:!this.label,title:this.label}):U({hidden:!this.label,title:this.label})}};import{defineElement as kt}from"./base.js";kt("sp-icon-target",w);import{html as zt}from"./base.js";var q=({width:t=24,height:e=24,hidden:i=!1,title:r="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var G=({width:t=24,height:e=24,hidden:i=!1,title:r="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(zt),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):G({hidden:!this.label,title:this.label})}};import{defineElement as Mt}from"./base.js";Mt("sp-icon-download",v);import{html as At}from"./base.js";var J=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var K=({width:t=24,height:e=24,hidden:i=!1,title:r="CCLibrary"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(At),this.spectrumVersion===2?J({hidden:!this.label,title:this.label}):K({hidden:!this.label,title:this.label})}};import{defineElement as Et}from"./base.js";Et("sp-icon-cclibrary",x);import{html as Ht}from"./base.js";var N=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Q=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Down"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(Ht),this.spectrumVersion===2?N({hidden:!this.label,title:this.label}):Q({hidden:!this.label,title:this.label})}};import{defineElement as St}from"./base.js";St("sp-icon-chevron-down",C);import{html as Dt}from"./base.js";var W=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var X=({width:t=24,height:e=24,hidden:i=!1,title:r="Chevron Left"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var b=class extends s{render(){return l(Dt),this.spectrumVersion===2?W({hidden:!this.label,title:this.label}):X({hidden:!this.label,title:this.label})}};import{defineElement as jt}from"./base.js";jt("sp-icon-chevron-left",b);import{html as Rt}from"./base.js";var Y=({width:t=24,height:e=24,hidden:i=!1,title:r="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var _=({width:t=24,height:e=24,hidden:i=!1,title:r="Add"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=class extends s{render(){return l(Rt),this.spectrumVersion===2?Y({hidden:!this.label,title:this.label}):_({hidden:!this.label,title:this.label})}};import{defineElement as Ft}from"./base.js";Ft("sp-icon-add",$);import{html as Ot}from"./base.js";var tt=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var et=({width:t=24,height:e=24,hidden:i=!1,title:r="Close"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var T=class extends s{render(){return l(Ot),this.spectrumVersion===2?tt({hidden:!this.label,title:this.label}):et({hidden:!this.label,title:this.label})}};import{defineElement as Pt}from"./base.js";Pt("sp-icon-close",T);import{html as Ut}from"./base.js";var rt=({width:t=24,height:e=24,hidden:i=!1,title:r="Checkmark Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var I=class extends s{render(){return l(Ut),this.spectrumVersion===2?rt({hidden:!this.label,title:this.label}):it({hidden:!this.label,title:this.label})}};import{defineElement as qt}from"./base.js";qt("sp-icon-checkmark-circle",I);import{html as Gt}from"./base.js";var ot=({width:t=24,height:e=24,hidden:i=!1,title:r="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var st=({width:t=24,height:e=24,hidden:i=!1,title:r="Image"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  </svg>`;var L=class extends s{render(){return l(Gt),this.spectrumVersion===2?ot({hidden:!this.label,title:this.label}):st({hidden:!this.label,title:this.label})}};import{defineElement as Jt}from"./base.js";Jt("sp-icon-image",L);
