...
import{html as tt}from"./base.js";import{html as Q,SpectrumElement as W}from"./base.js";import{SystemResolutionController as X,systemResolverUpdatedSymbol as Y}from"./reactive-controllers.js";import{property as Z,state as _}from"./base.js";import{css as G}from"./base.js";var J=G`
...
`,I=J;var K=Object.defineProperty,N=Object.getOwnPropertyDescriptor,T=(t,e,o,r)=>{for(var a=r>1?void 0:r?N(e,o):e,b=t.length-1,$;b>=0;b--)($=t[b])&&(a=(r?$(e,o,a):$(a))||a);return r&&a&&K(e,o,a),a},s=class extends W{constructor(){super(...arguments),this.unsubscribeSystemContext=null,this.spectrumVersion=1,this.label="",this.systemResolver=new X(this)}static get styles(){return[I]}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSystemContext&&(this.unsubscribeSystemContext(),this.unsubscribeSystemContext=null)}update(e){e.has("label")&&(this.label?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")),e.has(Y)&&(this.spectrumVersion=this.systemResolver.system==="spectrum-two"?2:1),super.update(e)}render(){return Q`
            <slot></slot>
        `}};T([_()],s.prototype,"spectrumVersion",2),T([Z({reflect:!0})],s.prototype,"label",2),T([Z({reflect:!0})],s.prototype,"size",2);var L,i=function(t,...e){return L?L(t,...e):e.reduce((o,r,a)=>o+r+t[a+1],t[0])},l=t=>{L=t};var m=({width:t=24,height:e=24,hidden:o=!1,title:r="Alert"}={})=>i`<svg
  ...
  >
    ...
    />
  </svg>`;var n=({width:t=24,height:e=24,hidden:o=!1,title:r="Alert Triangle"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var c=class extends s{render(){return l(tt),this.spectrumVersion===1?m({hidden:!this.label,title:this.label}):n({hidden:!this.label,title:this.label})}};import{defineElement as et}from"./base.js";et("sp-icon-alert",c);import{html as rt}from"./base.js";var h=class extends s{render(){return l(rt),this.spectrumVersion===2?n({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as ot}from"./base.js";ot("sp-icon-alert-triangle",h);import{html as it}from"./base.js";var z=({width:t=24,height:e=24,hidden:o=!1,title:r="Edit"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var k=({width:t=24,height:e=24,hidden:o=!1,title:r="Edit"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var p=class extends s{render(){return l(it),this.spectrumVersion===2?z({hidden:!this.label,title:this.label}):k({hidden:!this.label,title:this.label})}};import{defineElement as st}from"./base.js";st("sp-icon-edit",p);import{html as lt}from"./base.js";var B=({width:t=24,height:e=24,hidden:o=!1,title:r="Share Android"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var V=({width:t=24,height:e=24,hidden:o=!1,title:r="Share Android"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var d=class extends s{render(){return l(lt),this.spectrumVersion===2?B({hidden:!this.label,title:this.label}):V({hidden:!this.label,title:this.label})}};import{defineElement as at}from"./base.js";at("sp-icon-share-android",d);import{html as mt}from"./base.js";var A=({width:t=24,height:e=24,hidden:o=!1,title:r="Download"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var f=class extends s{render(){return l(mt),this.spectrumVersion===2?A({hidden:!this.label,title:this.label}):y({hidden:!this.label,title:this.label})}};import{defineElement as nt}from"./base.js";nt("sp-icon-download",f);import{html as ct}from"./base.js";var M=({width:t=24,height:e=24,hidden:o=!1,title:r="CCLibrary"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var E=({width:t=24,height:e=24,hidden:o=!1,title:r="CCLibrary"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var u=class extends s{render(){return l(ct),this.spectrumVersion===2?M({hidden:!this.label,title:this.label}):E({hidden:!this.label,title:this.label})}};import{defineElement as ht}from"./base.js";ht("sp-icon-cclibrary",u);import{html as pt}from"./base.js";var S=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Down"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var H=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Down"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var g=class extends s{render(){return l(pt),this.spectrumVersion===2?S({hidden:!this.label,title:this.label}):H({hidden:!this.label,title:this.label})}};import{defineElement as dt}from"./base.js";dt("sp-icon-chevron-down",g);import{html as ft}from"./base.js";var D=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Left"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var j=({width:t=24,height:e=24,hidden:o=!1,title:r="Chevron Left"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var w=class extends s{render(){return l(ft),this.spectrumVersion===2?D({hidden:!this.label,title:this.label}):j({hidden:!this.label,title:this.label})}};import{defineElement as ut}from"./base.js";ut("sp-icon-chevron-left",w);import{html as gt}from"./base.js";var R=({width:t=24,height:e=24,hidden:o=!1,title:r="Add"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var O=({width:t=24,height:e=24,hidden:o=!1,title:r="Add"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var v=class extends s{render(){return l(gt),this.spectrumVersion===2?R({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}};import{defineElement as wt}from"./base.js";wt("sp-icon-add",v);import{html as vt}from"./base.js";var P=({width:t=24,height:e=24,hidden:o=!1,title:r="Close"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var U=({width:t=24,height:e=24,hidden:o=!1,title:r="Close"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var x=class extends s{render(){return l(vt),this.spectrumVersion===2?P({hidden:!this.label,title:this.label}):U({hidden:!this.label,title:this.label})}};import{defineElement as xt}from"./base.js";xt("sp-icon-close",x);import{html as Ct}from"./base.js";var q=({width:t=24,height:e=24,hidden:o=!1,title:r="Checkmark Circle"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var F=({width:t=24,height:e=24,hidden:o=!1,title:r="Checkmark Circle"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;var C=class extends s{render(){return l(Ct),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):F({hidden:!this.label,title:this.label})}};import{defineElement as bt}from"./base.js";bt("sp-icon-checkmark-circle",C);
