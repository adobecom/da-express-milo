...
|---------|-----------|----------|---------|--------------|
| **A — Action Groups** | `BaseApiService` | Topic-based via `BaseActionGroup` | kuler, stock, curated | Yes |
| **B — Direct Handlers** | `BaseApiService` | Topic-based via `registerHandlers` | (none currently) | No |
