...
export const style = css`
    :host {
        width: var(--progress-circle-width, 64px);
        height: var(--progress-circle-height, 64px);
        direction: ltr;
        display: block;
        position: relative;
    ...
    .fills {
        animation: 1s cubic-bezier(0.25, 0.78, 0.48, 0.89) 0s infinite normal none running infinite-progress-ring;
        transform: translateZ(0);
    ...
    .fillSubMask1 {
        animation: 1s linear 0s infinite normal none running infinite-progress-fill-mask-1;
        transform: translateZ(0);
        will-change: transform;
    }
    ...
    .fill {
        border-radius: 100%;
        border: 4px solid rgb(2, 101, 220);
        width: var(--progress-circle-width, 64px);
        height: var(--progress-circle-height, 64px);
    }

    .fillSubMask2 {
        animation: 1s linear 0s infinite normal none running infinite-progress-fill-mask-2;
        transform: translateZ(0);
        will-change: transform;
    }

    @keyframes infinite-progress-fill-mask-1 {
        0% {
    ...
    @keyframes infinite-progress-fill-mask-2 {
        0% {
            transform: rotate(180deg);
        }
        1.69% {
    ...
    @keyframes infinite-progress-ring {
        0% {
            transform: rotate(-90deg);
        }
        100% {
