...
export const mapRange = (x, a, b, c, d) => c + (x - a) * ((d - c) / (b - a)),
    ...
    drawColorwheel = (v, radius, context) => {
        const x = radius,
            y = radius,
            hsl0 = hsvToHsl(0, 0, v),
            hsl1 = hsvToHsl(0, 1, v),
            s0 = Math.round(hsl0.s * 100),
            l0 = Math.round(hsl0.l * 100),
            s1 = Math.round(hsl1.s * 100),
            l1 = Math.round(hsl1.l * 100),
            wheel = [
                0, 0,
                15, 8,
                30, 17,
        ...
        let startAngle, endAngle, gradient, rgbHue;
